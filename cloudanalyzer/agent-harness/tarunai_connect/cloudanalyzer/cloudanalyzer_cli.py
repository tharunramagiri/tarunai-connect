"""tarunai-connect-cloudanalyzer — Command-line harness for CloudAnalyzer.
...
Usage:
    tarunai-connect-cloudanalyzer                               # start REPL
    tarunai-connect-cloudanalyzer --json evaluate run s.pcd r.pcd
    tarunai-connect-cloudanalyzer check run cloudanalyzer.yaml
    tarunai-connect-cloudanalyzer --json baseline decision qa/s.json --history-dir qa/history/
...
from tarunai_connect.cloudanalyzer.core.project import create_project
from tarunai_connect.cloudanalyzer.core.session import Session
from tarunai_connect.cloudanalyzer.utils import ca_backend
from tarunai_connect.cloudanalyzer.utils.repl_skin import ReplSkin
...
@click.version_option(VERSION, prog_name="tarunai-connect-cloudanalyzer")
@click.pass_context
