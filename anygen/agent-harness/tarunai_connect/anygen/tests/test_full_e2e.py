...
Run with:
    ANYGEN_API_KEY=sk-xxx python3 -m pytest tarunai_connect/anygen/tests/test_full_e2e.py -v -s
    TARUNAI_CONNECT_FORCE_INSTALLED=1 ANYGEN_API_KEY=sk-xxx python3 -m pytest ... -v -s
"""
...
from tarunai_connect.anygen.utils.anygen_backend import get_api_key, DOWNLOADABLE_OPERATIONS
from tarunai_connect.anygen.core.task import create_task, poll_task, download_file, run_full_workflow
...
def _resolve_cli(name):
    ...
    module = "tarunai_connect.anygen.anygen_cli"
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-anygen")
