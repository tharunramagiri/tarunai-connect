...
Usage:
    ...
    tarunai-connect-anygen task create --operation doc --prompt "Technical report"
    tarunai-connect-anygen task status <task-id>
...
from tarunai_connect.anygen.core.session import Session
from tarunai_connect.anygen.core import task as task_mod
from tarunai_connect.anygen.core import export as export_mod
...
def get_session() -> Session:
    ...
    if _session is None:
        ...
        sf = str(Path.home() / ".tarunai-connect-anygen" / "session.json")
...
def config_path():
    ...
    from tarunai_connect.anygen.utils.anygen_backend import CONFIG_FILE
...
def repl():
    ...
    from tarunai_connect.anygen.utils.repl_skin import ReplSkin
