...
class AgentHarnessPackagingTests(unittest.TestCase):
    def test_required_files_exist(self):
        required = [
            ...
            HARNESS_ROOT / "tarunai_connect" / "zotero" / "README.md",
            HARNESS_ROOT / "tarunai_connect" / "zotero" / "zotero_cli.py",
            HARNESS_ROOT / "tarunai_connect" / "zotero" / "utils" / "repl_skin.py",
            HARNESS_ROOT / "tarunai_connect" / "zotero" / "skills" / "SKILL.md",
            HARNESS_ROOT / "tarunai_connect" / "zotero" / "tests" / "TEST.md",
        ]
    ...
    def test_setup_reports_expected_name(self):
        ...
        self.assertEqual(result.stdout.strip(), "tarunai-connect-zotero")
    ...
    def test_skill_generator_regenerates_skill(self):
        ...
        try:
            ...
            self.assertIn("tarunai-connect-zotero", content)
