...
Usage:
    # One-shot commands
    tarunai-connect-drawio project new --preset letter -o my_diagram.drawio
    tarunai-connect-drawio shape add rectangle --label "Hello World"
    tarunai-connect-drawio connect <source_id> <target_id>

    # Interactive REPL
    tarunai-connect-drawio repl
"""
...
from tarunai_connect.drawio.core.session import Session
from tarunai_connect.drawio.core import project as proj_mod
from tarunai_connect.drawio.core import shapes as shapes_mod
from tarunai_connect.drawio.core import connectors as conn_mod
from tarunai_connect.drawio.core import pages as pages_mod
from tarunai_connect.drawio.core import export as export_mod
...
def project_xml():
    ...
    from tarunai_connect.drawio.utils.drawio_xml import xml_to_string
...
def repl(project_path):
    ...
    from tarunai_connect.drawio.utils.repl_skin import ReplSkin
        ...
        try:
            if cmd in ("quit", "exit", "q"):
                ...
                if not args:
                    ...
                    continue
                from tarunai_connect.drawio.utils import drawio_xml
