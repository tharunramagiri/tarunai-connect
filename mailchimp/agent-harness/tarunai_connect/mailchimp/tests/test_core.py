"""Unit tests for tarunai-connect-mailchimp core modules."""
...
class TestServerPrefix(unittest.TestCase):
    def test_extracts_suffix(self):
        from tarunai_connect.mailchimp.core.client import _server_prefix
...
class TestSubscriberHash(unittest.TestCase):
    def test_md5_lowercased(self):
        from tarunai_connect.mailchimp.core.client import subscriber_hash
...
class TestMailchimpClient(unittest.TestCase):
    def _make_client(self, key: str = "testkey-us1"):
        from tarunai_connect.mailchimp.core.client import MailchimpClient
    ...
    def test_missing_key_raises_auth_error(self):
        from tarunai_connect.mailchimp.core.client import MailchimpClient, MailchimpAuthError
        import os
    ...
    def test_get_client_exits_on_missing_key(self):
        from tarunai_connect.mailchimp.core.client import get_client
        import os
    ...
    def test_get_error_raises(self):
        from tarunai_connect.mailchimp.core.client import MailchimpClient, MailchimpError
...
class TestPagination(unittest.TestCase):
    ...
    def test_single_page(self):
        from tarunai_connect.mailchimp.core.pagination import paginate
    ...
    def test_collect_returns_total(self):
        from tarunai_connect.mailchimp.core.pagination import collect
...
class TestOutput(unittest.TestCase):
    def setUp(self):
        import tarunai_connect.mailchimp.utils.output as out
...
class TestGeneratedCommandsImport(unittest.TestCase):
    ...
    def test_all_groups_importable(self):
        from tarunai_connect.mailchimp.commands import ALL_GROUPS
    ...
    def test_generator_preserves_complete_first_line_help(self):
        from tarunai_connect.mailchimp._codegen.generate import _click_help_text
    ...
    def test_no_builtin_shadowing_in_function_names(self):
        ...
        for path in glob.glob("tarunai_connect/mailchimp/commands/*.py"):
    ...
    def test_generated_patch_command_forwards_query_params(self):
        ...
        from tarunai_connect.mailchimp.commands.audiences import audiences_group

        client = MagicMock()
        client.patch.return_value = {"id": "contact-1"}

        with patch("tarunai_connect.mailchimp.core.client.get_client", return_value=client):
    ...
    def test_generated_put_command_forwards_query_params(self):
        from click.testing import CliRunner
        from tarunai_connect.mailchimp.commands.lists import lists_group
    ...
    def test_generated_keyword_query_option_uses_safe_callback_name(self):
        from click.testing import CliRunner
        from tarunai_connect.mailchimp.commands.templates import templates_group
    ...
    def test_campaign_shortcut_aliases_match_generated_commands(self):
        from click.testing import CliRunner
        from tarunai_connect.mailchimp.commands.campaigns import campaigns_group
    ...
    def test_report_shortcut_aliases_match_generated_commands(self):
        from click.testing import CliRunner
        from tarunai_connect.mailchimp.commands.reports import reports_group
    ...
    def test_automation_and_segment_shortcut_aliases_match_generated_commands(self):
        from click.testing import CliRunner
        from tarunai_connect.mailchimp.commands.automations import automations_group
        from tarunai_connect.mailchimp.commands.lists import lists_group
    ...
    def test_ping_group_invokes_health_check_without_list_subcommand(self):
        from click.testing import CliRunner
        from tarunai_connect.mailchimp.mailchimp_cli import cli
    ...
    def test_cli_without_subcommand_starts_repl_through_click(self):
        from click.testing import CliRunner
        import tarunai_connect.mailchimp.mailchimp_cli as mailchimp_cli
