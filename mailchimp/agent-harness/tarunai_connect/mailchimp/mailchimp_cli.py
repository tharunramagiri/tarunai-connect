"""tarunai-connect harness for the Mailchimp Marketing API v3.0."""

from __future__ import annotations

import click

import tarunai_connect.mailchimp.utils.output as _output_mod
...
@click.version_option("0.1.0", prog_name="tarunai-connect-mailchimp")
@click.pass_context
...
def _start_repl() -> None:
    ...
    from tarunai_connect.mailchimp.utils.repl_skin import ReplSkin
    import shlex
