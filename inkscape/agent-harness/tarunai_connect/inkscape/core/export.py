...
from tarunai_connect.inkscape.core.document import project_to_svg, save_svg
from tarunai_connect.inkscape.core.text import layout_text_lines, text_anchor_x
from tarunai_connect.inkscape.utils.svg_utils import serialize_svg
...
def _get_style_val(obj: Dict[str, Any], key: str, default: str = "") -> str:
    ...
    from tarunai_connect.inkscape.utils.svg_utils import parse_style
