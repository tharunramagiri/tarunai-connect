"""Unit tests for tarunai-connect-browser — Core modules with mocked MCP backend.

These tests use synthetic data and mock the MCP backend. No Chrome or DOMShell required.

Usage:
    python -m pytest tarunai_connect/browser/tests/test_core.py -v
"""

import pytest
from unittest.mock import AsyncMock, MagicMock, patch

from tarunai_connect.browser.core.session import Session
from tarunai_connect.browser.core import page, fs
...
class TestPageModule:
    ...
    def test_open_page_updates_session(self):
        ...
        with patch("tarunai_connect.browser.core.page.backend.open_url") as mock_open:
    ...
    def test_reload_page(self):
        ...
        with patch("tarunai_connect.browser.core.page.backend.reload") as mock_reload:
    ...
    def test_go_back_updates_session(self):
        ...
        with patch("tarunai_connect.browser.core.page.backend.back") as mock_back:
    ...
    def test_go_forward_updates_session(self):
        ...
        with patch("tarunai_connect.browser.core.page.backend.forward") as mock_forward:
...
class TestFsModule:
    ...
    def test_list_elements(self):
        ...
        with patch("tarunai_connect.browser.core.fs.backend.ls") as mock_ls:
    ...
    def test_change_directory_absolute_path(self):
        ...
        with patch("tarunai_connect.browser.core.fs.backend.cd") as mock_cd:
    ...
    def test_read_element(self):
        ...
        with patch("tarunai_connect.browser.core.fs.backend.cat") as mock_cat:
    ...
    def test_grep_elements(self):
        ...
        with patch("tarunai_connect.browser.core.fs.backend.grep") as mock_grep:
    ...
    def test_grep_elements_with_path(self):
        ...
        with patch("tarunai_connect.browser.core.fs.backend.grep") as mock_grep, \
             patch("tarunai_connect.browser.core.fs.backend.cd") as mock_cd:
