"""E2E tests for tarunai-connect-browser — Requires Chrome + DOMShell extension.

These tests interact with real Chrome and DOMShell. Skip if DOMShell is not available.

Usage:
    python -m pytest tarunai_connect/browser/tests/test_full_e2e.py -v
"""
...
from tarunai_connect.browser.utils.domshell_backend import is_available
from tarunai_connect.browser.browser_cli import cli
...
class TestDaemonMode:
    ...
    def test_daemon_lifecycle(self, runner):
        ...
        To run manually:
            ...
            tarunai-connect-browser fs pwd
