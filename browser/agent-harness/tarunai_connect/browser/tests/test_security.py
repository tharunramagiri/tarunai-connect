...
from tarunai_connect.browser.utils import security
...
from tarunai_connect.browser.utils.security import (
    get_allowed_schemes,
    get_blocked_schemes,
...
class TestURLValidation:
    ...
    def test_uppercase_scheme_accepted(self, monkeypatch):
        ...
        monkeypatch.setenv("TARUNAI_CONNECT_BROWSER_ALLOWED_SCHEMES", "HTTP,HTTPS")
        _reload_security_module()
        is_valid, error = validate_url("http://example.com")
        assert is_valid
        assert error == ""
    ...
    def test_fdn_example_com_not_blocked(self, monkeypatch):
        ...
        monkeypatch.delenv("TARUNAI_CONNECT_BROWSER_BLOCK_PRIVATE", raising=False)
        _reload_security_module()
...
class TestPrivateNetworkBlocking:
    ...
    def test_private_network_blocking_enabled(self, monkeypatch):
        ...
        monkeypatch.setenv("TARUNAI_CONNECT_BROWSER_BLOCK_PRIVATE", "true")
        _reload_security_module()
