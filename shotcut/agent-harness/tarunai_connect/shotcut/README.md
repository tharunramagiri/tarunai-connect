...
tarunai-connect-shotcut --json --project edit.mlt preview capture --recipe quick
...
tarunai-connect-shotcut --json --project edit.mlt preview live status --recipe quick
```
