...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-shotcut")
...
class TestMeltRenderE2E:
    def test_render_color_bars_mp4(self):
        from tarunai_connect.shotcut.utils.melt_backend import render_color_bars
    ...
    def test_render_mlt_xml_file(self):
        from tarunai_connect.shotcut.utils.melt_backend import find_melt
