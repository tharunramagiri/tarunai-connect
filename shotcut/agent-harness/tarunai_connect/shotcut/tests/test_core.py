...
from tarunai_connect.shotcut.core import session as session_mod
...
from tarunai_connect.shotcut.utils.time import (
    timecode_to_frames, frames_to_timecode, parse_time_input,
    frames_to_seconds, seconds_to_frames,
)
from tarunai_connect.shotcut.utils.mlt_xml import (
...
class TestSession:
    ...
    def test_undo_redo(self):
        ...
        assert not s.undo()
        s.checkpoint()
        from tarunai_connect.shotcut.utils.mlt_xml import add_track_to_tractor
