...
tarunai_connect.iterm2_ctl.utils.iterm2_backend.run_iterm2().
"""
...
async def create_tab(
    ...
    if window_id:
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import async_find_window
...
async def close_tab(connection, tab_id: str, force: bool = False) -> Dict[str, Any]:
    """Close a tab by ID."""
    from tarunai_connect.iterm2_ctl.utils.iterm2_backend import async_find_tab
