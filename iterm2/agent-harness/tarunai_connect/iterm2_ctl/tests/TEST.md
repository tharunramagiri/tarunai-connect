# Test Plan — tarunai-connect-iterm2
...
Uses `_resolve_cli("tarunai-connect-iterm2")` — runs installed command as a real user would.

| Test | Description | Verifies |
|------|-------------|---------|
| `test_cli_help` | `tarunai-connect-iterm2 --help` | exit code 0 |
...
**Command:**
```bash
TARUNAI_CONNECT_FORCE_INSTALLED=1 python3.12 -m pytest tarunai_connect/iterm2_ctl/tests/ -v --tb=no
```

**[_resolve_cli] Using installed command: /opt/homebrew/bin/tarunai-connect-iterm2**
...
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_clear PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_defaults PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_from_dict PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_from_dict_missing_keys PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_summary_empty PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_summary_full PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_summary_partial_tab_only PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_summary_partial_window_only PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStateDefaults::test_to_dict PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStatePersistence::test_clear_state PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStatePersistence::test_load_invalid_json_returns_empty PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStatePersistence::test_load_missing_file_returns_empty PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStatePersistence::test_overwrite_existing_state PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStatePersistence::test_save_and_load_roundtrip PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStatePersistence::test_save_creates_parent_dir PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestSessionStatePersistence::test_saved_file_is_valid_json PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestIterm2Backend::test_connection_error_help_content PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestIterm2Backend::test_find_iterm2_app_absent PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestIterm2Backend::test_find_iterm2_app_present PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestIterm2Backend::test_require_iterm2_running_import_error PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_app_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_arrangement_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_json_flag_in_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_main_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_profile_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_session_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_session_send_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_session_split_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_tab_help PASSED
tarunai_connect/iterm2_ctl/tests/test_core.py::TestCLIHelp::test_window_help PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestAppStatus::test_app_status PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestAppStatus::test_get_current_context PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestWindowOperations::test_list_windows PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestWindowOperations::test_create_and_close_window PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestWindowOperations::test_window_frame PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestTabOperations::test_list_tabs PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestTabOperations::test_create_and_close_tab PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestSessionOperations::test_list_sessions PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestSessionOperations::test_send_text_and_read_screen PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestSessionOperations::test_split_pane PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestProfileOperations::test_list_profiles PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestProfileOperations::test_list_color_presets PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestArrangementOperations::test_arrangement_save_list_restore PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestCLISubprocess::test_help PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestCLISubprocess::test_json_app_status PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestCLISubprocess::test_json_window_list PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestCLISubprocess::test_json_session_list PASSED
tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestCLISubprocess::test_json_profile_list PASSED
...
| Subprocess tests | 4 (using installed `tarunai-connect-iterm2`) |

### Run: Phase 6 — After tmux additions (2026-03-22)

**Command:**
```bash
TARUNAI_CONNECT_FORCE_INSTALLED=1 python3.12 -m pytest tarunai_connect/iterm2_ctl/tests/ -v --tb=short
```
...
| Subprocess tests | 6 (using installed `tarunai-connect-iterm2`) |
...
# then in another tab:
TARUNAI_CONNECT_FORCE_INSTALLED=1 python3.12 -m pytest tarunai_connect/iterm2_ctl/tests/test_full_e2e.py::TestTmuxOperations -v -s
```
