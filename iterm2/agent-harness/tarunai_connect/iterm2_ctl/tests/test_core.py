"""Unit tests for tarunai-connect-iterm2 core modules.
...
from tarunai_connect.iterm2_ctl.core.session_state import (
    SessionState,
    clear_state,
    load_state,
    save_state,
...
class TestIterm2Backend(unittest.TestCase):
    def test_find_iterm2_app_absent(self):
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import find_iterm2_app
    ...
    def test_require_iterm2_running_import_error(self):
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import require_iterm2_running
    ...
    def test_connection_error_help_content(self):
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import connection_error_help
...
class TestCLIHelp(unittest.TestCase):
    ...
    def _invoke(self, args):
        ...
        from tarunai_connect.iterm2_ctl.iterm2_ctl_cli import cli
        runner = CliRunner()
...
class TestTmuxCore(unittest.TestCase):
    ...
    def test_resolve_connection_empty_raises(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.tmux import _resolve_connection

            mock_conn = MagicMock()

            with patch(
                "tarunai_connect.iterm2_ctl.core.tmux._ensure_app_and_connections",
    ...
    def test_list_connections_empty(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.tmux import list_connections
    ...
    def test_send_command_returns_output(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.tmux import send_command
            ...
            with patch(
                "tarunai_connect.iterm2_ctl.core.tmux._resolve_connection",
    ...
    def test_set_window_visible_on(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.tmux import set_window_visible
...
class TestBroadcastCore(unittest.TestCase):
    ...
    def test_get_broadcast_domains_empty(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.broadcast import get_broadcast_domains
    ...
    def test_clear_broadcast_calls_set(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.broadcast import clear_broadcast
...
class TestMenuCore(unittest.TestCase):
    ...
    def test_list_common_menu_items_structure(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.menu import list_common_menu_items
    ...
    def test_select_menu_item_calls_api(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.menu import select_menu_item
...
class TestPrefCore(unittest.TestCase):
    ...
    def test_parse_value_bool_true(self):
        from tarunai_connect.iterm2_ctl.core.pref import _parse_value
    ...
    def test_set_tmux_preference_unknown_setting(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.pref import set_tmux_preference
            with self.assertRaises(ValueError) as ctx:
...
class TestPromptCore(unittest.TestCase):
    ...
    def test_prompt_to_dict_none(self):
        ...
        from tarunai_connect.iterm2_ctl.core.prompt import _prompt_to_dict
    ...
    def test_get_last_prompt_returns_unavailable_for_none(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.prompt import get_last_prompt
    ...
    def test_list_prompts_empty(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.prompt import list_prompts
...
class TestTmuxBootstrap(unittest.TestCase):
    ...
    def test_bootstrap_timeout_raises(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.tmux import bootstrap
...
class TestDialogsCore(unittest.TestCase):
    def test_show_alert_calls_api(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.dialogs import show_alert
    ...
    def test_show_text_input_cancelled(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.dialogs import show_text_input
    ...
    def test_show_open_panel_cancelled(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.dialogs import show_open_panel
...
class TestTabSelectPane(unittest.TestCase):
    def test_invalid_direction_raises(self):
        ...
        async def _run():
            from tarunai_connect.iterm2_ctl.core.tab import select_pane_in_direction
    ...
    def test_valid_direction_calls_api(self):
        ...
        async def _run():
            ...
            with patch("tarunai_connect.iterm2_ctl.utils.iterm2_backend.async_find_tab",
...
class TestGetProcessName(unittest.TestCase):
    def test_returns_none_for_none_pid(self):
        from tarunai_connect.iterm2_ctl.core.session import _get_process_name
