"""E2E tests for tarunai-connect-iterm2.
...
Prerequisites:
  ...
  3. pip install iterm2 tarunai-connect-iterm2  (or pip install -e .)

Run with:
  python3 -m pytest tarunai_connect/iterm2_ctl/tests/test_full_e2e.py -v -s
  TARUNAI_CONNECT_FORCE_INSTALLED=1 python3 -m pytest ... -v -s
"""
import json
import os
import shutil
...
def _resolve_cli(name: str):
    ...
    Set env TARUNAI_CONNECT_FORCE_INSTALLED=1 to require the installed command.
    """
    ...
    module = "tarunai_connect.iterm2_ctl.iterm2_ctl_cli"
...
def iterm2_connection():
    ...
    try:
        ...
        from tarunai_connect.iterm2_ctl.core.window import list_windows
...
class TestAppStatus:
    ...
    def test_get_current_context(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.window import get_current_window
...
class TestWorkspaceSnapshot:
    def test_workspace_snapshot_structure(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.session import workspace_snapshot
...
class TestWindowOperations:
    ...
    def test_create_and_close_window(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.window import (
    ...
    def test_window_frame(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.window import create_window, close_window, get_window_frame
...
class TestTabOperations:
    def test_list_tabs(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.tab import list_tabs
    ...
    def test_create_and_close_tab(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.window import create_window, close_window
        from tarunai_connect.iterm2_ctl.core.tab import create_tab, list_tabs
...
class TestSessionOperations:
    def test_list_sessions(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.session import list_sessions
    ...
    def test_send_text_and_read_screen(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.window import create_window, close_window
        from tarunai_connect.iterm2_ctl.core.session import (
    ...
    def test_split_pane(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.window import create_window, close_window
        from tarunai_connect.iterm2_ctl.core.session import split_pane, list_sessions
...
class TestProfileOperations:
    def test_list_profiles(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.profile import list_profiles
    ...
    def test_list_color_presets(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.profile import list_color_presets
...
class TestArrangementOperations:
    def test_arrangement_save_list_restore(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.arrangement import (
...
class TestTmuxOperations:
    ...
    def test_list_tmux_tabs_always_works(self, iterm2_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.tmux import list_tmux_tabs
    ...
    def test_create_and_verify_tmux_window(self, tmux_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.tmux import create_window, list_tmux_tabs
        from tarunai_connect.iterm2_ctl.core.window import close_window
    ...
    def test_set_window_visible_roundtrip(self, tmux_connection):
        ...
        from tarunai_connect.iterm2_ctl.utils.iterm2_backend import run_iterm2
        from tarunai_connect.iterm2_ctl.core.tmux import (
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-iterm2")
