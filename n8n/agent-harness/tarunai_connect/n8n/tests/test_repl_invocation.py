"""Regression test for issue #278: tarunai-connect-n8n REPL must not TypeError on print_banner.

The bug: n8n_cli.py called print_banner(base_url or "(not configured)") but
print_banner takes no arguments, so invoking `tarunai-connect-n8n` with no
...
from tarunai_connect.n8n import n8n_cli
from tarunai_connect.n8n.utils import repl_skin
