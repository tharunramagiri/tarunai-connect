...
from tarunai_connect.n8n.core import (
    credentials,
    executions,
    project,
    tags,
...
from tarunai_connect.n8n.utils import n8n_backend
...
class TestBackend:
    ...
    @patch("tarunai_connect.n8n.utils.n8n_backend.requests.request")
...
class TestWorkflows:
    @patch("tarunai_connect.n8n.core.workflows.api_get")
    ...
    @patch("tarunai_connect.n8n.core.workflows.api_post")
    ...
    @patch("tarunai_connect.n8n.core.workflows.api_delete")
    ...
    @patch("tarunai_connect.n8n.core.workflows.api_put")
...
class TestExecutions:
    @patch("tarunai_connect.n8n.core.executions.api_get")
    ...
    @patch("tarunai_connect.n8n.core.executions.api_post")
    ...
    @patch("tarunai_connect.n8n.core.executions.api_delete")
...
class TestCredentials:
    @patch("tarunai_connect.n8n.core.credentials.api_post")
    ...
    @patch("tarunai_connect.n8n.core.credentials.api_get")
    ...
    @patch("tarunai_connect.n8n.core.credentials.api_delete")
    def test_delete_credential(self, mock_del):
        mock_del.return_value = {}
        credentials.delete_credential("c1", base_url=BASE, api_key=KEY)
        mock_del.assert_called_once()

    @patch("tarunai_connect.n8n.core.credentials.api_put")
...
class TestVariables:
    @patch("tarunai_connect.n8n.core.variables.api_get")
    ...
    @patch("tarunai_connect.n8n.core.variables.api_post")
...
class TestTags:
    @patch("tarunai_connect.n8n.core.tags.api_get")
    ...
    @patch("tarunai_connect.n8n.core.tags.api_post")
...
class TestLoadJsonArg:
    def test_parse_inline_json(self):
        from tarunai_connect.n8n.n8n_cli import _load_json_arg
...
class TestCLICommands:
    def test_export_import_roundtrip(self, tmp_path):
        ...
        from tarunai_connect.n8n.n8n_cli import _clean_for_api, _load_json_arg
...
class TestVersions:
    def test_save_and_list(self, tmp_path, monkeypatch):
        from tarunai_connect.n8n.core import versions as ver
...
class TestFixers:
    def test_expression_format(self):
        from tarunai_connect.n8n.core.fixers import autofix
...
class TestNodes:
    @patch("tarunai_connect.n8n.core.nodes.requests.get")
    def test_search_nodes(self, mock_get):
        from tarunai_connect.n8n.core import nodes as nd
        mock_resp = MagicMock()
...
class TestScaffolds:
    def test_list_patterns(self):
        from tarunai_connect.n8n.core.scaffolds import list_patterns
    ...
    def test_get_scaffold(self):
        from tarunai_connect.n8n.core.scaffolds import get_scaffold
...
class TestExpressions:
    def test_valid_expression(self):
        from tarunai_connect.n8n.core.expressions import validate_expression
...
class TestTemplates:
    @patch("tarunai_connect.n8n.core.templates.requests.get")
    def test_search_templates(self, mock_get):
        from tarunai_connect.n8n.core import templates as tmpl
        mock_resp = MagicMock()
