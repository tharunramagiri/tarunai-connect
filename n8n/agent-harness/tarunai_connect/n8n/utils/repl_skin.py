"""tarunai-connect REPL Skin — Unified terminal interface for all CLI harnesses.

Copy this file into your CLI package at:
    tarunai_connect/<software>/utils/repl_skin.py

Usage:
    from tarunai_connect.<software>.utils.repl_skin import ReplSkin
...
# Brand colors
_CYAN = "\033[38;5;80m"       # tarunai-connect brand cyan
...
_SKILL_SOURCE_REPO = os.environ.get("TARUNAI_CONNECT_SKILL_REPO", "tharunramagiri/tarunai-connect")

# ── Brand icon ────────────────────────────────────────────────────────

# The tarunai-connect icon: a small colored diamond/chevron mark
...
class ReplSkin:
    """Unified REPL skin for tarunai-connect CLIs.

    Provides consistent branding, prompts, and message formatting
    across all CLI harnesses built with the tarunai-connect methodology.
    """
    ...
    def __init__(self, software: str, version: str = "1.0.0",
        ...
        Args:
            ...
            history_file: Path for persistent command history.
                         Defaults to ~/.tarunai-connect-<software>/history
        ...
        self.skill_id = f"tarunai-connect-{self.skill_slug}"
        self.skill_install_cmd = (
            f"npx skills add {_SKILL_SOURCE_REPO} --skill {self.skill_id} -g -y"
        )
        global_skill_root = Path(
            os.environ.get("TARUNAI_CONNECT_GLOBAL_SKILLS_DIR", str(Path.home() / ".agents" / "skills"))
        ).expanduser()
        ...
        # inside the tarunAI Connect monorepo. Fall back to the packaged
        # tarunai_connect/<software>/skills/SKILL.md for installed harnesses.
        ...
        if history_file is None:
            hist_dir = Path.home() / f".tarunai-connect-{self.software}"
    ...
    def _detect_color_support(self) -> bool:
        ...
        if os.environ.get("NO_COLOR"):
            return False
        if os.environ.get("TARUNAI_CONNECT_NO_COLOR"):
            return False
    ...
    def print_banner(self):
        ...
        # Title:  ◆  tarunai-connect · N8N
        icon = self._c(_CYAN + _BOLD, "◆")
        brand = self._c(_CYAN + _BOLD, "tarunai-connect")
...
def _get_skin() -> ReplSkin:
    ...
    if _skin is None:
        ...
        try:
            from tarunai_connect.n8n.n8n_cli import VERSION
        except ImportError:
            VERSION = "0.0.0"
...
def print_banner() -> None:
    """Print the tarunai-connect branded banner."""
