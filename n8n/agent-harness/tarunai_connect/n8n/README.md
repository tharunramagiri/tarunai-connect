...
[![PyPI](https://img.shields.io/pypi/v/tarunai-connect-n8n.svg)](https://pypi.org/project/tarunai-connect-n8n/)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
[![tarunAI Connect](https://img.shields.io/badge/CLI--Anything-harness-orange.svg)](https://github.com/tharunramagiri/tarunai-connect)
...
Built with the [tarunAI Connect](https://github.com/tharunramagiri/tarunai-connect) pattern, so AI agents can use it too.
...
# Try it!
tarunai-connect-n8n workflow list
```
...
```bash
tarunai-connect-n8n --json workflow list
tarunai-connect-n8n --json execution list --status error
```
...
| Config file | 3 | `tarunai-connect-n8n config set ...` |
...
# Run all unit tests
python3 -m pytest tarunai_connect/n8n/tests/test_core.py -v

# Run E2E tests (needs a running n8n instance)
export N8N_BASE_URL=https://your-n8n.com
export N8N_API_KEY=your-key
python3 -m pytest tarunai_connect/n8n/tests/test_full_e2e.py -v
```
...
│   └── repl_skin.py    # Terminal UI (standard tarunai-connect skin)
├── skills/
