# tarunAI Connect NotebookLM Harness

Experimental NotebookLM harness for tarunAI Connect.

This package wraps an installed `notebooklm` CLI and exposes a tarunAI Connect-style
...
tarunai-connect-notebooklm auth status

# List notebooks
tarunai-connect-notebooklm notebook list
```
...
tarunai-connect-notebooklm auth status
tarunai-connect-notebooklm notebook list
tarunai-connect-notebooklm source list --notebook nb_123
tarunai-connect-notebooklm chat ask "Summarize the current notebook"
tarunai-connect-notebooklm artifact generate-report --notebook nb_123
```
...
This harness is inspired by the tarunAI Connect methodology:
