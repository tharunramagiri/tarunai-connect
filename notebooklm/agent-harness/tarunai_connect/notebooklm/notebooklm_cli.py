...
from tarunai_connect.notebooklm import __version__
from tarunai_connect.notebooklm.core.session import Session
from tarunai_connect.notebooklm.utils.notebooklm_backend import run_notebooklm
...
def repl():
    ...
    click.echo(f"tarunai-connect-notebooklm v{__version__}")
