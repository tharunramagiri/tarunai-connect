...
Usage:
    # One-shot commands
    tarunai-connect-qgis project new -o demo.qgz --title "Demo"
    tarunai-connect-qgis --project demo.qgz layer create-vector --name places --geometry point --field name:string
    tarunai-connect-qgis --project demo.qgz feature add --layer places --wkt "POINT(1 2)" --attr name=HQ
    tarunai-connect-qgis --project demo.qgz layout create --name Main
    tarunai-connect-qgis --project demo.qgz export pdf out.pdf --layout Main --overwrite
...
from tarunai_connect.qgis import __version__
from tarunai_connect.qgis.core import export as export_mod
from tarunai_connect.qgis.core import features as features_mod
from tarunai_connect.qgis.core import layers as layers_mod
from tarunai_connect.qgis.core import layouts as layouts_mod
from tarunai_connect.qgis.core import processing as processing_mod
from tarunai_connect.qgis.core import project as project_mod
from tarunai_connect.qgis.core.session import Session
from tarunai_connect.qgis.utils.qgis_backend import QgisBackendError, QgisProcessError
...
def get_session() -> Session:
    ...
    global _session
    if _session is None:
        session_dir = Path.home() / ".tarunai-connect-qgis"
...
def repl():
    ...
    from tarunai_connect.qgis.utils.repl_skin import ReplSkin
