...
tarunai-connect-qgis --json --project demo.qgz layout add-label --layout Main --text "Demo map" --x 10 --y 8 --width 120 --height 10
...
tarunai-connect-qgis --json --project demo.qgz export image output.png --layout Main --overwrite

# Inspect processing algorithms
tarunai-connect-qgis --json process list
...
```bash
python3 -m pytest tarunai_connect/qgis/tests/test_core.py -v
python3 -m pytest tarunai_connect/qgis/tests/test_full_e2e.py -v -s
```
