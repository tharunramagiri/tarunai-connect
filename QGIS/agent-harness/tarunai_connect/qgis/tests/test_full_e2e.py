"""End-to-end and subprocess tests for tarunai-connect-qgis."""
...
from tarunai_connect.qgis import qgis_cli
from tarunai_connect.qgis.core import project as project_mod
from tarunai_connect.qgis.qgis_cli import cli
...
def _resolve_cli(name: str) -> list[str]:
    ...
    module = "tarunai_connect.qgis.qgis_cli"
...
class TestCLISubprocess:
    def test_help(self, tmp_path: Path):
        command = _resolve_cli("tarunai-connect-qgis")
        env = os.environ.copy()
