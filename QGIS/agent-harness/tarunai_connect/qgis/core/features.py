"""Feature editing helpers for tarunai-connect-qgis."""

from __future__ import annotations

from tarunai_connect.qgis.core.layers import get_layer, layer_summary
from tarunai_connect.qgis.utils.qgis_backend import QgisBackendError, ensure_qgis_app
