...
class TestSubstitute:
    def test_string_substitution(self):
        from tarunai_connect.macrocli.core.macro_model import substitute
...
class TestMacroRegistry:
    ...
    def test_register_programmatic(self):
        from tarunai_connect.macrocli.core.registry import MacroRegistry
        from tarunai_connect.macrocli.core.macro_model import MacroDefinition, MacroStep
...
class TestNativeAPIBackend:
    ...
    def test_run_command_success(self):
        from tarunai_connect.macrocli.backends.native_api import NativeAPIBackend
        b = NativeAPIBackend()
...
class TestFileTransformBackend:
    ...
    def test_json_set_and_get(self, tmp_path):
        from tarunai_connect.macrocli.backends.file_transform import FileTransformBackend
        from tarunai_connect.macrocli.core.macro_model import MacroStep
...
class TestStepResult:
    def test_to_dict(self):
        from tarunai_connect.macrocli.backends.base import StepResult
...
class TestExecutionSession:
    def test_record_and_retrieve(self):
        from tarunai_connect.macrocli.core.session import ExecutionSession, RunRecord
    ...
    def test_save_and_load(self, tmp_path, monkeypatch):
        from tarunai_connect.macrocli.core import session as sess_mod
        import tarunai_connect.macrocli.core.session as sess_module
