...
def _resolve_cli(name: str) -> list[str]:
    ...
    module = "tarunai_connect.macrocli.macrocli_cli"
    print(f"[_resolve_cli] Falling back to: {sys.executable} -m {module}")
    return [sys.executable, "-m", "tarunai_connect.macrocli"]
...
class TestFileTransformE2E:
    def test_json_set_and_verify(self, tmp_path):
        ...
        from tarunai_connect.macrocli.core.macro_model import MacroDefinition, MacroStep, MacroCondition, MacroOutput
...
class TestNativeAPIE2E:
    def test_run_real_command_and_capture(self, tmp_path):
        ...
        from tarunai_connect.macrocli.core.macro_model import MacroDefinition
        from tarunai_connect.macrocli.core.registry import MacroRegistry
        from tarunai_connect.macrocli.core.runtime import MacroRuntime
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-macrocli")
