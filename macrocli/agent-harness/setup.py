#!/usr/bin/env python3
"""
setup.py for tarunai-connect-macrocli
...
with open("tarunai_connect/macrocli/README.md", "r", encoding="utf-8") as fh:
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "tarunai-connect-macrocli=tarunai_connect.macrocli.macrocli_cli:cli",
        ],
    },
    package_data={
