"""Unit tests for tarunai-connect-eth2-quickstart."""
...
from tarunai_connect.eth2_quickstart.core import project
from tarunai_connect.eth2_quickstart.core.commands import validator_plan
from tarunai_connect.eth2_quickstart.eth2_quickstart_cli import cli
...
class TestCLI:
    ...
    @patch("tarunai_connect.eth2_quickstart.eth2_quickstart_cli.Eth2QuickStartBackend")
...
class TestBackendErrors:
    ...
    @patch("tarunai_connect.eth2_quickstart.utils.eth2qs_backend.subprocess.run")
