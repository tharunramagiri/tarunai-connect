"""tarunai-connect-eth2-quickstart CLI."""
...
from tarunai_connect.eth2_quickstart import __version__
from tarunai_connect.eth2_quickstart.core.commands import (
    VALID_CONSENSUS_CLIENTS,
    VALID_EXECUTION_CLIENTS,
    VALID_MEV_OPTIONS,
    VALID_NETWORKS,
)
from tarunai_connect.eth2_quickstart.core.install import install_clients, setup_node
from tarunai_connect.eth2_quickstart.core.rpc import start_rpc
from tarunai_connect.eth2_quickstart.core.status import health_check, status
from tarunai_connect.eth2_quickstart.core.validator import configure_validator
from tarunai_connect.eth2_quickstart.utils.eth2qs_backend import Eth2QuickStartBackend
...
def repl(ctx: click.Context):
    ...
    from tarunai_connect.eth2_quickstart.utils.repl_skin import ReplSkin
