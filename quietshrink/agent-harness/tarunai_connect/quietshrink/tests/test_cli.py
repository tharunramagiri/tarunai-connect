"""Smoke tests for the tarunai-connect-quietshrink harness.
...
from tarunai_connect.quietshrink import __version__
from tarunai_connect.quietshrink.quietshrink_cli import cli, find_bash_cli
...
class TestCompress:
    @patch("tarunai_connect.quietshrink.quietshrink_cli.find_bash_cli")
    @patch("subprocess.run")
