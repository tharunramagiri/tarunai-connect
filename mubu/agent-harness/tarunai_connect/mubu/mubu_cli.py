...
import mubu_probe
from tarunai_connect.mubu import __version__
from tarunai_connect.mubu.utils import ReplSkin


CONTEXT_SETTINGS = {"ignore_unknown_options": True, "allow_extra_args": True}
COMMAND_HISTORY_LIMIT = 50
PUBLIC_PROGRAM_NAME = "mubu-cli"
COMPAT_PROGRAM_NAME = "tarunai-connect-mubu"
DISCOVER_COMMANDS = {
...
def session_state_dir() -> Path:
    override = os.environ.get("TARUNAI_CONNECT_MUBU_STATE_DIR", "").strip()
    if override:
