...
This directory is now the stricter tarunAI Connect-style harness root for Mubu.
...
- the same `tarunai-connect-mubu` console script is exposed
...
- canonical package source is now under `agent-harness/tarunai_connect/mubu/...`
