"""tarunai-connect-sbox - Click-based CLI harness for the s&box game engine.
...
from tarunai_connect.sbox.core import (
...
from tarunai_connect.sbox.core import material as material_mod
from tarunai_connect.sbox.core import sound as sound_mod
from tarunai_connect.sbox.core import localization as localization_mod
from tarunai_connect.sbox.core import validate as validate_mod
from tarunai_connect.sbox.utils import sbox_backend
from tarunai_connect.sbox.core import test_orchestrator as test_mod
...
def cli( ctx, json_output, project_path ):
    """tarunai-connect-sbox - CLI harness for the s&box game engine."""
...
def scene_list_presets( ctx ):
    ...
    try:
        from tarunai_connect.sbox.core.scene import COMPONENT_PRESETS
...
def prefab_list( ctx ):
    ...
    try:
        ...
        if not project_dir:
            _output_error( ctx, "No project found" )
            return
        from tarunai_connect.sbox.core import export as export_mod_local
...
_REPL_BANNER = """
 ...
 tarunai-connect-sbox - interactive REPL
...
def repl( ctx ):
    ...
    try:
        from tarunai_connect.sbox.utils.repl_skin import ReplSkin
