"""End-to-end and CLI subprocess tests for tarunai-connect-sbox.
...
def _resolve_cli(name):
    ...
    force = os.environ.get("TARUNAI_CONNECT_FORCE_INSTALLED", "").strip().lower() in {"1", "true", "yes"}
    ...
    # Hardcoded mapping - this test suite only resolves tarunai-connect-sbox
    if name == "tarunai-connect-sbox":
        module = "tarunai_connect.sbox.sbox_cli"
    else:
...
class TestE2EProjectWorkflow:
    ...
    def test_full_project_creation(self, tmp_path):
        ...
        from tarunai_connect.sbox.core import project as project_mod
    ...
    def test_scene_manipulation_workflow(self, tmp_path):
        ...
        from tarunai_connect.sbox.core import project as project_mod
        from tarunai_connect.sbox.core import scene as scene_mod
    ...
    def test_codegen_workflow(self, tmp_path):
        ...
        from tarunai_connect.sbox.core import codegen as codegen_mod
    ...
    def test_input_collision_workflow(self, tmp_path):
        ...
        from tarunai_connect.sbox.core import project as project_mod
        from tarunai_connect.sbox.core import input_config as input_config_mod
        from tarunai_connect.sbox.core import collision_config as collision_config_mod
    ...
    def test_material_sound_workflow( self, tmp_path ):
        ...
        from tarunai_connect.sbox.core import project as proj
        from tarunai_connect.sbox.core import material as mat
        from tarunai_connect.sbox.core import sound as snd
    ...
    def test_scene_modify_workflow( self, tmp_path ):
        ...
        from tarunai_connect.sbox.core import project as proj
        from tarunai_connect.sbox.core import scene as sc
...
def _sbox_available():
    try:
        from tarunai_connect.sbox.utils.sbox_backend import find_sbox_installation
...
class TestE2EBackend:
    ...
    def test_get_sbox_version(self):
        ...
        from tarunai_connect.sbox.utils.sbox_backend import get_sbox_version
    ...
    def test_find_server_executable(self):
        ...
        from tarunai_connect.sbox.utils.sbox_backend import find_executable
...
class TestCLISubprocess:
    """Test the installed tarunai-connect-sbox command via subprocess."""

    @classmethod
    def setup_class(cls):
        try:
            cls.CLI_BASE = _resolve_cli("tarunai-connect-sbox")
    ...
    def test_help(self):
        ...
        assert "tarunai-connect-sbox" in result.stdout or "sbox" in result.stdout.lower()
