"""Unit tests for tarunai_connect.sbox.core modules.
...
from tarunai_connect.sbox.core.codegen import (
    generate_class,
    generate_component,
...
from tarunai_connect.sbox.core.collision_config import (
    add_layer,
    add_rule,
...
from tarunai_connect.sbox.core.export import (
    ASSET_EXTENSIONS,
    find_asset_refs,
    find_project_dir,
    find_unused_assets,
...
from tarunai_connect.sbox.core.input_config import (
    add_action,
...
from tarunai_connect.sbox.core.localization import (
    bulk_set,
...
from tarunai_connect.sbox.core.material import (
    create_material,
    list_materials,
    parse_material,
    update_material,
)
from tarunai_connect.sbox.core.prefab import (
    create_prefab,
    diff_prefabs,
    from_scene_object,
    get_prefab_info,
...
from tarunai_connect.sbox.core.project import (
    add_package,
    configure_project,
    create_project,
    find_sbproj,
...
from tarunai_connect.sbox.core.scene import (
    COMPONENT_PRESETS,
    add_component,
    add_object,
    bulk_modify_objects,
...
from tarunai_connect.sbox.core.session import Session
from tarunai_connect.sbox.core.sound import (
    create_sound_event,
    parse_sound_event,
    update_sound_event,
)
from tarunai_connect.sbox.core.validate import validate_project
...
class TestProject:
    """Tests for tarunai_connect.sbox.core.project."""
...
class TestScene:
    """Tests for tarunai_connect.sbox.core.scene."""
...
class TestPrefab:
    """Tests for tarunai_connect.sbox.core.prefab."""
...
class TestCodegen:
    """Tests for tarunai_connect.sbox.core.codegen."""
...
class TestInputConfig:
    """Tests for tarunai_connect.sbox.core.input_config."""
...
class TestCollisionConfig:
    """Tests for tarunai_connect.sbox.core.collision_config."""
...
class TestSession:
    """Tests for tarunai_connect.sbox.core.session."""
...
class TestExport:
    """Tests for tarunai_connect.sbox.core.export."""
