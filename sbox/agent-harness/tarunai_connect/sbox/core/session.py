...
_DEFAULT_SESSION_DIR = os.path.join( Path.home(), ".tarunai-connect-sbox" )
...
class Session:
    ...
    Session file is stored at ~/.tarunai-connect-sbox/session.json by default.
    ...
    def __init__( self, session_path: Optional[str] = None ) -> None:
        ...
        Args:
            session_path: Path to the session JSON file.
                          Defaults to ~/.tarunai-connect-sbox/session.json
        """
