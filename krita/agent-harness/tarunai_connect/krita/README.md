...
tarunai-connect-krita project new -n "My Painting" -w 2048 -h 2048 -o project.json

# Add layers
tarunai-connect-krita --project project.json layer add "Sketch" -t paintlayer
tarunai-connect-krita --project project.json layer add "Colors" -t paintlayer --opacity 200
tarunai-connect-krita --project project.json layer add "Background" -t paintlayer

# Apply filters
tarunai-connect-krita --project project.json filter apply blur -l "Background"

# Export to PNG
tarunai-connect-krita --project project.json export render output.png -p png --overwrite

# JSON output mode (for AI agents)
tarunai-connect-krita --json --project project.json project info
tarunai-connect-krita --json --project project.json layer list
```
...
tarunai-connect-krita --project project.json
```
