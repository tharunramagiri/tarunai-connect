"""End-to-end tests for tarunai-connect-krita.
...
from tarunai_connect.krita.core.project import (
    create_project,
    add_layer,
    save_project,
    add_filter,
...
from tarunai_connect.krita.core.export import (
    build_kra_from_project,
    export_image,
)
from tarunai_connect.krita.utils.krita_backend import find_krita
...
class TestCLISubprocess:
    """Test the installed tarunai-connect-krita command via subprocess."""

    CLI_BASE = _resolve_cli("tarunai-connect-krita")
