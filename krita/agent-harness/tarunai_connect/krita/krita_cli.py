...
from tarunai_connect.krita.core.session import Session
...
from tarunai_connect.krita.utils.krita_backend import find_krita, get_version
...
def cli(ctx, use_json, project, dry_run):
    """tarunai-connect-krita: CLI harness for Krita digital painting."""
...
def repl(ctx, project_path):
    ...
    try:
        from tarunai_connect.krita.utils.repl_skin import ReplSkin
    except ImportError:
