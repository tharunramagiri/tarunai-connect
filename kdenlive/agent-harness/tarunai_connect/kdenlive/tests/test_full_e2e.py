...
from tarunai_connect.kdenlive.core.project import create_project, save_project, open_project, get_project_info
from tarunai_connect.kdenlive.core.bin import import_clip, list_clips
from tarunai_connect.kdenlive.core.timeline import (
    add_track, add_clip_to_track, remove_clip_from_track,
    trim_clip, split_clip, move_clip, list_tracks,
)
from tarunai_connect.kdenlive.core.filters import add_filter, list_filters, FILTER_REGISTRY
from tarunai_connect.kdenlive.core.transitions import add_transition, list_transitions
from tarunai_connect.kdenlive.core.guides import add_guide, list_guides
from tarunai_connect.kdenlive.core.export import generate_kdenlive_xml, list_render_presets, RENDER_PRESETS
from tarunai_connect.kdenlive.core.session import Session
from tarunai_connect.kdenlive.utils.mlt_xml import (
...
class TestWorkflowE2E:
    ...
    def test_all_profiles_produce_valid_xml(self):
        from tarunai_connect.kdenlive.core.project import PROFILES
...
class TestMeltBackend:
    ...
    def test_melt_is_installed(self):
        from tarunai_connect.kdenlive.utils.melt_backend import find_melt
        path = find_melt()
        assert os.path.exists(path)
        print(f"\n  melt binary: {path}")

    def test_melt_version(self):
        from tarunai_connect.kdenlive.utils.melt_backend import get_melt_version
...
class TestMeltRenderE2E:
    ...
    def test_render_color_bars_mp4(self):
        ...
        from tarunai_connect.kdenlive.utils.melt_backend import render_color_bars
