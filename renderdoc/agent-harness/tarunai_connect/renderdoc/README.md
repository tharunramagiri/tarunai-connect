...
```bash
# Show capture info
tarunai-connect-renderdoc --capture frame.rdc capture info

# List all draw calls
tarunai-connect-renderdoc -c frame.rdc actions list --draws-only

# Get action summary
tarunai-connect-renderdoc -c frame.rdc actions summary

# Save a texture as PNG
tarunai-connect-renderdoc -c frame.rdc textures save <resourceId> -o output.png

# Pick a pixel
tarunai-connect-renderdoc -c frame.rdc textures pick <resourceId> 100 200
...
# Read buffer data
tarunai-connect-renderdoc -c frame.rdc resources read-buffer <resourceId> --format float32

# JSON output for all commands
tarunai-connect-renderdoc -c frame.rdc --json actions list
```
