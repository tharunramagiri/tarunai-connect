...
def capture(
    ...
    *,
    ...
    manifest = finalize_bundle(
        ...
        generator={
            "entry_point": "tarunai-connect-renderdoc",
            "harness_version": HARNESS_VERSION,
            "command": command or f"tarunai-connect-renderdoc -c {capture_path} preview capture --recipe {recipe}",
        },
    ...
    *,
    ...
    manifest = finalize_bundle(
        ...
        generator={
            ...
            "harness_version": HARNESS_VERSION,
            "command": command
            or f"tarunai-connect-renderdoc -c {capture_path_a} preview diff {event_a} {event_b} --capture-b {capture_path_b}",
        },
        status="partial" if warnings else "ok",
        warnings=warnings or None,
