...
class TestOutputUtils:
    ...
    def test_output_table(self):
        from tarunai_connect.renderdoc.utils.output import output_table
        import io
        buf = io.StringIO()
        output_table(
            [["Alice", 30], ["Bob", 25]],
    ...
    def test_format_size(self):
        from tarunai_connect.renderdoc.utils.output import format_size
...
class TestActionsModule:
    @patch("tarunai_connect.renderdoc.core.actions.rd")
    def test_decode_flags(self, mock_rd):
        # Patch the flag values
        mock_rd.ActionFlags = MockActionFlags
        from tarunai_connect.renderdoc.core.actions import _decode_flags
    ...
    def test_action_to_dict(self, mock_rd):
        mock_rd.ActionFlags = MockActionFlags
        from tarunai_connect.renderdoc.core.actions import _action_to_dict
    ...
    def test_list_actions_flat(self, mock_rd):
        mock_rd.ActionFlags = MockActionFlags
        from tarunai_connect.renderdoc.core.actions import list_actions
    ...
    def test_get_drawcalls_only(self, mock_rd):
        mock_rd.ActionFlags = MockActionFlags
        from tarunai_connect.renderdoc.core.actions import get_drawcalls_only
...
class TestTexturesModule:
    ...
    def test_tex_to_dict(self):
        from tarunai_connect.renderdoc.core.textures import _tex_to_dict
...
class TestCLIHelp:
    ...
    def test_main_help(self):
        ...
        from tarunai_connect.renderdoc.renderdoc_cli import cli
        runner = CliRunner()
    ...
    def test_cli_help_subprocess(self):
        ...
        try:
            result = subprocess.run(
                [sys.executable, "-m", "tarunai_connect.renderdoc.renderdoc_cli", "--help"],
                capture_output=True,
                text=True,
                timeout=10,
...
class TestDiffModule:
    ...
    def test_identical_snapshots(self):
        from tarunai_connect.renderdoc.core.diff import diff_pipeline_from_snapshots
    ...
    def test_float_tolerance(self):
        from tarunai_connect.renderdoc.core.diff import _values_equal
    ...
    def test_diff_dicts_missing_key(self):
        from tarunai_connect.renderdoc.core.diff import _diff_dicts
    ...
    def test_cbuffer_variable_diff(self):
        from tarunai_connect.renderdoc.core.diff import _diff_cbuffer_vars
...
class TestPreviewModule:
    ...
    def test_capture_bundle(self, tmp_path, monkeypatch):
        from tarunai_connect.renderdoc.core import preview as preview_mod
        from tarunai_connect.renderdoc.core import actions as actions_mod
        from tarunai_connect.renderdoc.core import textures as textures_mod
        from tarunai_connect.renderdoc.core import pipeline as pipeline_mod
    ...
    def test_diff_bundle(self, tmp_path, monkeypatch):
        ...
        from tarunai_connect.renderdoc.core import textures as textures_mod
        from tarunai_connect.renderdoc.core import pipeline as pipeline_mod
        from tarunai_connect.renderdoc.core import diff as diff_mod
