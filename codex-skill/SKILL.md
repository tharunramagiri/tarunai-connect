...
description: Use when the user wants Codex to build, refine, test, or validate a tarunAI Connect harness for a GUI application or source repository. Adapts the tarunAI Connect methodology to Codex without changing the generated Python harness format.
---

# tarunAI Connect for Codex

Use this skill when the user wants Codex to act like the `tarunAI Connect` builder.
