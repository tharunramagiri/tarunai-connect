...
from tarunai_connect.blender.core.scene import create_scene, save_scene, open_scene, get_scene_info
from tarunai_connect.blender.core.objects import add_object, remove_object, duplicate_object, transform_object, list_objects
from tarunai_connect.blender.core.materials import create_material, assign_material, set_material_property, list_materials
from tarunai_connect.blender.core.modifiers import add_modifier, list_modifiers
from tarunai_connect.blender.core.lighting import add_camera, add_light, set_camera, set_light, list_cameras, list_lights
from tarunai_connect.blender.core.animation import add_keyframe, set_frame_range, set_fps, list_keyframes
from tarunai_connect.blender.core.render import set_render_settings, render_scene, generate_bpy_script, get_render_settings
from tarunai_connect.blender.core import preview as preview_mod
from tarunai_connect.blender.core.session import Session
from tarunai_connect.blender.utils.bpy_gen import generate_full_script
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-blender")
...
class TestBlenderBackend:
    ...
    def test_blender_is_installed(self):
        from tarunai_connect.blender.utils.blender_backend import find_blender
        path = find_blender()
        assert os.path.exists(path)
        print(f"\n  Blender binary: {path}")

    def test_blender_version(self):
        from tarunai_connect.blender.utils.blender_backend import get_version
        version = get_version()
...
class TestBlenderRenderE2E:
    ...
    def test_render_simple_cube(self, tmp_dir):
        ...
        from tarunai_connect.blender.utils.blender_backend import render_scene_headless
...
class TestBlenderRenderScriptE2E:
    ...
    def test_run_minimal_bpy_script(self, tmp_dir):
        ...
        from tarunai_connect.blender.utils.blender_backend import render_script
