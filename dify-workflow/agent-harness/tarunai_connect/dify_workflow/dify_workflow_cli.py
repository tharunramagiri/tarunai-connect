#!/usr/bin/env python3
"""tarunAI Connect wrapper for the upstream dify-workflow CLI."""
...
from tarunai_connect.dify_workflow import __version__
from tarunai_connect.dify_workflow.utils.dify_workflow_backend import run_dify_workflow
from tarunai_connect.dify_workflow.utils.repl_skin import ReplSkin
...
@click.version_option(version=__version__, prog_name="tarunai-connect-dify-workflow")
@click.pass_context
def cli(ctx: click.Context) -> None:
    """tarunAI Connect wrapper for the Dify workflow DSL editor."""
