...
from tarunai_connect.dify_workflow.utils.dify_workflow_backend import require_dify_workflow_command
...
class TestWrapperE2E:
    CLI_BASE = _resolve_cli("tarunai-connect-dify-workflow", "tarunai_connect.dify_workflow")
