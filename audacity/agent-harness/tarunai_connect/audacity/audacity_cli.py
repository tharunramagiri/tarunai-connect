...
from tarunai_connect.audacity.core import project as proj_mod
from tarunai_connect.audacity.core import tracks as track_mod
from tarunai_connect.audacity.core import clips as clip_mod
from tarunai_connect.audacity.core import effects as fx_mod
from tarunai_connect.audacity.core import labels as label_mod
from tarunai_connect.audacity.core import selection as sel_mod
from tarunai_connect.audacity.core import media as media_mod
from tarunai_connect.audacity.core import export as export_mod
...
def eval_cmd(out_dir, baseline_path, update_baseline, fail_on_regression):
    ...
    from tarunai_connect.audacity.eval.runner import run_eval
...
def repl(project_path):
    ...
    from tarunai_connect.audacity.utils.repl_skin import ReplSkin
