...
def state_dir() -> Path:
    override = os.environ.get("TARUNAI_CONNECT_UNREALINSIGHTS_STATE_DIR", "").strip()
    base = Path(override).expanduser() if override else Path.home() / ".tarunai-connect-unrealinsights"
