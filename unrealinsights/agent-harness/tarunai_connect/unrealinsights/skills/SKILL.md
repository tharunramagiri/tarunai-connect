...
tarunai-connect-unrealinsights --json trace info
```
...
tarunai-connect-unrealinsights --json -t D:\captures\session.utrace export timer-stats D:\out\stats.csv --region=EXPORT_CAPTURE
tarunai-connect-unrealinsights --json -t D:\captures\session.utrace export counter-values D:\out\counter_values.csv --counter=*
```
...
```powershell
tarunai-connect-unrealinsights --json -t D:\captures\session.utrace batch run-rsp D:\out\exports.rsp
```
