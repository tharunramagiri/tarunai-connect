...
def _resolve_cli(name: str):
    ...
    return [sys.executable, "-m", "tarunai_connect.unrealinsights.unrealinsights_cli"]
...
def _cli_env():
    ...
    env["TARUNAI_CONNECT_UNREALINSIGHTS_STATE_DIR"] = os.path.join(HARNESS_ROOT, ".tmp_state")
    return env


class TestCLISmoke:
    CLI_BASE = _resolve_cli("tarunai-connect-unrealinsights")
