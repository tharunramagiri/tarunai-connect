...
def _session_state_dir(tmp_path, monkeypatch):
    monkeypatch.setenv("TARUNAI_CONNECT_UNREALINSIGHTS_STATE_DIR", str(tmp_path / "state"))
...
class TestOutputUtils:
    def test_output_json(self):
        ...
        from tarunai_connect.unrealinsights.utils.output import output_json
    ...
    def test_output_table_empty(self):
        ...
        from tarunai_connect.unrealinsights.utils.output import output_table
    ...
    def test_format_size(self):
        from tarunai_connect.unrealinsights.utils.output import format_size
...
class TestErrorUtils:
    def test_handle_error(self):
        from tarunai_connect.unrealinsights.utils.errors import handle_error
...
class TestBackendDiscovery:
    @patch("tarunai_connect.unrealinsights.utils.unrealinsights_backend._read_windows_product_version", return_value="5.5.4")
    def test_explicit_path_precedence(self, _mock_version, tmp_path, monkeypatch):
        from tarunai_connect.unrealinsights.utils.unrealinsights_backend import resolve_unrealinsights_exe
    ...
    def test_build_insights_command(self, tmp_path):
        from tarunai_connect.unrealinsights.utils.unrealinsights_backend import build_insights_command
    ...
    def test_build_insights_command_line(self, tmp_path):
        from tarunai_connect.unrealinsights.utils.unrealinsights_backend import build_insights_command_line
    ...
    @patch("tarunai_connect.unrealinsights.utils.unrealinsights_backend._read_windows_product_version", return_value="5.3.0")
    def test_resolve_binary_from_engine_root(self, _mock_version, tmp_path):
        from tarunai_connect.unrealinsights.utils.unrealinsights_backend import resolve_binary_from_engine_root
    ...
    @patch("tarunai_connect.unrealinsights.utils.unrealinsights_backend.subprocess.run")
    def test_build_engine_program(self, mock_run, tmp_path):
        from tarunai_connect.unrealinsights.utils.unrealinsights_backend import build_engine_program
    ...
    @patch("tarunai_connect.unrealinsights.utils.unrealinsights_backend._read_windows_product_version", return_value="5.3.0")
    @patch("tarunai_connect.unrealinsights.utils.unrealinsights_backend.build_engine_program")
    def test_ensure_engine_unrealinsights_builds_when_missing(self, mock_build, _mock_version, tmp_path):
        from tarunai_connect.unrealinsights.utils.unrealinsights_backend import ensure_engine_unrealinsights
...
class TestCaptureCore:
    def test_normalize_trace_output_path_prefers_explicit(self, tmp_path):
        from tarunai_connect.unrealinsights.core.capture import normalize_trace_output_path
    ...
    def test_build_exec_cmds_arg(self):
        from tarunai_connect.unrealinsights.core.capture import build_exec_cmds_arg
    ...
    def test_resolve_engine_root_from_engine_subdir(self, tmp_path):
        from tarunai_connect.unrealinsights.core.capture import resolve_engine_root
    ...
    def test_resolve_editor_target(self, tmp_path):
        from tarunai_connect.unrealinsights.core.capture import resolve_editor_target
    ...
    def test_resolve_capture_target_from_project_and_engine(self, tmp_path):
        from tarunai_connect.unrealinsights.core.capture import resolve_capture_target
    ...
    def test_build_capture_command(self, tmp_path):
        from tarunai_connect.unrealinsights.core.capture import build_capture_command
    ...
    @patch("tarunai_connect.unrealinsights.core.capture.backend.run_process")
    def test_run_capture_wait_requires_clean_exit(self, mock_run_process, tmp_path):
        from tarunai_connect.unrealinsights.core.capture import run_capture
    ...
    def test_capture_status(self):
        from tarunai_connect.unrealinsights.core.capture import capture_status
        from tarunai_connect.unrealinsights.core.session import UnrealInsightsSession
        ...
        with patch("tarunai_connect.unrealinsights.core.capture.backend.is_process_running", return_value=True):
            data = capture_status(session)
        assert data["active"] is True
        assert data["running"] is True

    def test_snapshot_capture(self, tmp_path):
        from tarunai_connect.unrealinsights.core.capture import snapshot_capture
        from tarunai_connect.unrealinsights.core.session import UnrealInsightsSession
    ...
    def test_stop_capture(self):
        from tarunai_connect.unrealinsights.core.capture import stop_capture
        from tarunai_connect.unrealinsights.core.session import UnrealInsightsSession
        ...
        with patch("tarunai_connect.unrealinsights.core.capture.backend.terminate_process", return_value={"requested_pid": 9876, "stopped": True, "exit_code": 0}), \
             patch("tarunai_connect.unrealinsights.core.capture.backend.is_process_running", return_value=False):
...
class TestExportCore:
    ...
    def test_build_export_exec_command(self, exporter, expected, tmp_path):
        from tarunai_connect.unrealinsights.core.export import build_export_exec_command
    ...
    def test_build_rsp_exec_command(self, tmp_path):
        from tarunai_connect.unrealinsights.core.export import build_rsp_exec_command
    ...
    def test_normalize_rsp_line_modern_windows_avoids_nested_quotes(self, tmp_path):
        from tarunai_connect.unrealinsights.core.export import _normalize_rsp_line
    ...
    @patch("tarunai_connect.unrealinsights.core.export.backend.parse_unreal_log")
    @patch("tarunai_connect.unrealinsights.core.export.backend.run_process")
    def test_execute_export_classifies_no_output(self, mock_run, mock_log, tmp_path):
        from tarunai_connect.unrealinsights.core.export import execute_export
    ...
    def test_expected_outputs_from_rsp(self, tmp_path):
        from tarunai_connect.unrealinsights.core.export import expected_outputs_from_rsp
    ...
    def test_normalize_response_file_lines_unquotes_filename_without_spaces(self, tmp_path):
        from tarunai_connect.unrealinsights.core.export import normalize_response_file_lines
    ...
    def test_normalized_response_file_path_writes_temp_file(self, tmp_path):
        from tarunai_connect.unrealinsights.core.export import normalized_response_file_path
    ...
    def test_collect_materialized_outputs_placeholder(self, tmp_path):
        from tarunai_connect.unrealinsights.core.export import collect_materialized_outputs
...
class TestStoreCore:
    def test_list_trace_files_includes_ucache_and_live_flag(self, tmp_path):
        from tarunai_connect.unrealinsights.core.store import list_trace_files
    ...
    def test_latest_trace_file(self, tmp_path):
        from tarunai_connect.unrealinsights.core.store import latest_trace_file
    ...
    @patch("tarunai_connect.unrealinsights.core.store.backend.resolve_trace_server_exe")
    def test_trace_store_info(self, mock_resolve, tmp_path, monkeypatch):
        from tarunai_connect.unrealinsights.core.store import trace_store_info
...
class TestLiveCore:
    @patch("tarunai_connect.unrealinsights.core.live.subprocess.run")
    def test_list_unreal_processes_windows_json(self, mock_run):
        from tarunai_connect.unrealinsights.core.live import list_unreal_processes
        ...
        with patch("tarunai_connect.unrealinsights.core.live.os.name", "nt"):
    ...
    def test_live_exec_requires_backend(self, monkeypatch):
        from tarunai_connect.unrealinsights.core.live import execute_live_command
    ...
    @patch("tarunai_connect.unrealinsights.core.live.backend.run_process")
...
class TestGuiCore:
    def test_build_gui_command_has_no_headless_flags(self, tmp_path):
        from tarunai_connect.unrealinsights.core.gui import build_gui_command
    ...
    @patch("tarunai_connect.unrealinsights.core.gui.backend.run_process")
    def test_open_gui_keeps_running(self, mock_run, tmp_path):
        from tarunai_connect.unrealinsights.core.gui import open_gui
...
class TestAnalyzeCore:
    def test_summarize_exports_from_synthetic_csv(self, tmp_path):
        from tarunai_connect.unrealinsights.core.analyze import summarize_exports
    ...
    @patch("tarunai_connect.unrealinsights.core.analyze.execute_export")
    def test_analyze_summary_runs_export_bundle(self, mock_export, tmp_path):
        from tarunai_connect.unrealinsights.core.analyze import analyze_summary
...
class TestCLIHelp:
    def test_main_help(self):
        from tarunai_connect.unrealinsights.unrealinsights_cli import cli
...
class TestCLIJsonErrors:
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.resolve_unrealinsights_exe")
    ...
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.resolve_unrealinsights_exe")
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.resolve_trace_server_exe")
    ...
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.ensure_engine_unrealinsights")
    ...
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.capture_status")
    ...
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.stop_capture")
    ...
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.snapshot_capture")
    ...
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.trace_store_info")
    ...
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.gui_status")
...
class TestREPLSessionState:
    def test_trace_set_then_info_in_repl(self):
        ...
        with patch(
            "tarunai_connect.unrealinsights.utils.repl_skin.ReplSkin.create_prompt_session",
            return_value=None,
        ):
            runner = CliRunner()
...
class TestCaptureCLIConvenience:
    @patch("tarunai_connect.unrealinsights.unrealinsights_cli.run_capture")
