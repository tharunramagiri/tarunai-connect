...
```bash
pip install git+https://github.com/tharunramagiri/tarunai-connect.git#subdirectory=3MF/agent-harness
```
...
tarunai-connect-3mf resize model.3mf --hole 0 --hole 1 --hole 2 --hole 3 --diameter 4.2 -o output.3mf

# Repair mesh issues
tarunai-connect-3mf repair model.3mf -o repaired.3mf

# Compare two files
tarunai-connect-3mf compare original.3mf modified.3mf
...
MIT — See [tarunAI Connect LICENSE](https://github.com/tharunramagiri/tarunai-connect/blob/main/LICENSE)
