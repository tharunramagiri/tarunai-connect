...
Usage:
    # One-shot commands
    tarunai-connect-3mf info model.3mf
    tarunai-connect-3mf inspect model.3mf
    tarunai-connect-3mf resize model.3mf --hole 0 --hole 1 --diameter 4.2 -o output.3mf
    tarunai-connect-3mf --json inspect model.3mf
...
from tarunai_connect.threemf.core import parser
from tarunai_connect.threemf.core import inspector
from tarunai_connect.threemf.core import modifier
from tarunai_connect.threemf.core import repair as repair_mod
...
def repl():
    ...
    from tarunai_connect.threemf.utils.repl_skin import ReplSkin
