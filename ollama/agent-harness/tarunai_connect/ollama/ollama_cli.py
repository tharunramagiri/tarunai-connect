...
Usage:
    ...
    tarunai-connect-ollama generate text --model llama3.2 --prompt "Hello"
...
from tarunai_connect.ollama.core import models as models_mod
from tarunai_connect.ollama.core import generate as gen_mod
from tarunai_connect.ollama.core import embeddings as embed_mod
from tarunai_connect.ollama.core import server as server_mod
...
def repl():
    ...
    from tarunai_connect.ollama.utils.repl_skin import ReplSkin
