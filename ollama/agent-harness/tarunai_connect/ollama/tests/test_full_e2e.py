"""E2E tests for tarunai-connect-ollama — requires Ollama running at localhost:11434.

These tests interact with a real Ollama server. Skip if Ollama is not available.

Usage:
    python -m pytest tarunai_connect/ollama/tests/test_full_e2e.py -v
"""

import pytest
from click.testing import CliRunner

from tarunai_connect.ollama.utils.ollama_backend import is_available, DEFAULT_BASE_URL
from tarunai_connect.ollama.ollama_cli import cli
