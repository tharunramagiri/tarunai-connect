...
# Option B: CLI config
tarunai-connect-rms config set api_token your_token_here
```
...
# Get device details
tarunai-connect-rms devices get 12345

# List online devices with JSON output
tarunai-connect-rms --json devices list --status online

# List alerts for a device
tarunai-connect-rms alerts list --device 12345

# Get device location
tarunai-connect-rms location get 12345
```
