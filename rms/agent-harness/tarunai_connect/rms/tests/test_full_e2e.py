"""E2E tests for tarunai-connect-rms — requires valid RMS_API_TOKEN."""
...
class TestAPIConnectivity:
    def test_api_connectivity(self):
        from tarunai_connect.rms.utils.rms_backend import api_get, get_api_token
...
class TestDevicesE2E:
    ...
    def test_get_device(self):
        from tarunai_connect.rms.core.devices import list_devices, get_device
        from tarunai_connect.rms.utils.rms_backend import get_api_token
...
class TestCLIIntegrationE2E:
    def _run_cli(self, *args):
        cmd = [sys.executable, "-m", "tarunai_connect.rms", "--json", *args]
