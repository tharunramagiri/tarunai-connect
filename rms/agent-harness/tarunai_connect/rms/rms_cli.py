...
Usage:
    tarunai-connect-rms devices list
    tarunai-connect-rms devices get <id>
    tarunai-connect-rms alerts list
    tarunai-connect-rms  # Interactive REPL
"""
...
from tarunai_connect.rms.utils.rms_backend import get_api_token, load_config, save_config
...
def _get_session():
    global _session
    if _session is None:
        sf = str(Path.home() / ".tarunai-connect-rms" / "session.json")
...
def devices_update(device_id, name, tag):
    """Update device."""
    from tarunai_connect.rms.core.devices import update_device
    data = {}
    if name:
        data["name"] = name
    if tag:
...
def devices_delete(device_id):
    """Delete device."""
    from tarunai_connect.rms.core.devices import delete_device
...
def companies_get(company_id):
    """Get company details."""
    from tarunai_connect.rms.core.companies import get_company
...
def companies_update(company_id, name):
    """Update company."""
    from tarunai_connect.rms.core.companies import update_company
    data = {}
    if name:
        data["name"] = name
    if not data:
...
def companies_delete(company_id):
    """Delete company."""
    from tarunai_connect.rms.core.companies import delete_company
...
def tags_get(tag_id):
    """Get tag details."""
    from tarunai_connect.rms.core.tags import get_tag
...
def tags_update(tag_id, name):
    """Update tag."""
    from tarunai_connect.rms.core.tags import update_tag
    data = {}
    if name:
        data["name"] = name
    if not data:
...
def tags_delete(tag_id):
    """Delete tag."""
    from tarunai_connect.rms.core.tags import delete_tag
...
def alerts_get(alert_id):
    """Get alert details."""
    from tarunai_connect.rms.core.alerts import get_alert
...
def alerts_delete(alert_id):
    """Delete alert."""
    from tarunai_connect.rms.core.alerts import delete_alert
...
def alert_configs_list(limit, offset):
    ...
    from tarunai_connect.rms.core.alerts import list_alert_configs
...
def alert_configs_get(config_id):
    ...
    from tarunai_connect.rms.core.alerts import get_alert_config
...
def alert_configs_create(data_json):
    ...
    from tarunai_connect.rms.core.alerts import create_alert_config
...
def alert_configs_update(config_id, data_json):
    ...
    from tarunai_connect.rms.core.alerts import update_alert_config
    data = json.loads(data_json)
...
def alert_configs_delete(config_id):
    ...
    from tarunai_connect.rms.core.alerts import delete_alert_config
...
def location_history(device_id, limit, offset):
    ...
    from tarunai_connect.rms.core.location import list_location_history
...
def report_templates_get(template_id):
    """Get report template."""
    from tarunai_connect.rms.core.reports import get_template
...
def report_templates_update(template_id, data_json):
    ...
    from tarunai_connect.rms.core.reports import update_template
    data = json.loads(data_json)
...
def report_templates_delete(template_id):
    ...
    from tarunai_connect.rms.core.reports import delete_template
...
def config_path():
    ...
    from tarunai_connect.rms.utils.rms_backend import CONFIG_FILE
...
def repl():
    ...
    from tarunai_connect.rms.utils.repl_skin import ReplSkin
