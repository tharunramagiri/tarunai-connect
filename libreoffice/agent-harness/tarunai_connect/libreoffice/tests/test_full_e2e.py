...
from tarunai_connect.libreoffice.core.document import create_document, save_document, open_document, get_document_info
from tarunai_connect.libreoffice.core.writer import (
    add_paragraph, add_heading, add_list, add_table, add_page_break,
    list_content, remove_content,
)
from tarunai_connect.libreoffice.core.calc import add_sheet, set_cell, get_cell, list_sheets, remove_sheet
from tarunai_connect.libreoffice.core.impress import (
    add_slide, remove_slide, set_slide_content, add_slide_element, list_slides,
)
from tarunai_connect.libreoffice.core.styles import create_style, apply_style, list_styles
from tarunai_connect.libreoffice.core.export import (
    export, to_odt, to_ods, to_odp, to_html, to_text, list_presets,
)
from tarunai_connect.libreoffice.core import importer as importer_mod
from tarunai_connect.libreoffice.core.session import Session
from tarunai_connect.libreoffice.utils.odf_utils import validate_odf, parse_odf, ODF_MIMETYPES
from tarunai_connect.libreoffice.utils.lo_backend import find_libreoffice, get_version, convert_odf_to
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-libreoffice")
...
class TestWriterToPDF:
    ...
    def test_simple_writer_to_pdf(self, tmp_dir):
        ...
        add_paragraph(proj, text="This paragraph was generated by tarunai-connect-libreoffice "
