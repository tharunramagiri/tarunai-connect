...
# Create a stub
tarunai-connect-wiremock stub quick GET /api/hello 200 --body '{"hello":"world"}'

# List stubs
tarunai-connect-wiremock stub list

# Verify a request was made
tarunai-connect-wiremock request count '{"method":"GET","url":"/api/hello"}'
```
