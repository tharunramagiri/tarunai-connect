"""Unit tests for tarunai_connect.wiremock core modules.
...
class TestWireMockClient(unittest.TestCase):
    def setUp(self):
        from tarunai_connect.wiremock.utils.client import WireMockClient
...
class TestSession(unittest.TestCase):
    def test_from_env_defaults(self):
        from tarunai_connect.wiremock.core.session import Session
        env = {}
...
class TestStubsManager(unittest.TestCase):
    def setUp(self):
        from tarunai_connect.wiremock.utils.client import WireMockClient
        from tarunai_connect.wiremock.core.stubs import StubsManager
...
class TestRequestsLog(unittest.TestCase):
    def setUp(self):
        from tarunai_connect.wiremock.utils.client import WireMockClient
        from tarunai_connect.wiremock.core.requests_log import RequestsLog
        self.client = WireMockClient()
...
class TestScenariosManager(unittest.TestCase):
    def setUp(self):
        from tarunai_connect.wiremock.utils.client import WireMockClient
        from tarunai_connect.wiremock.core.scenarios import ScenariosManager
        self.client = WireMockClient()
...
class TestRecordingManager(unittest.TestCase):
    def setUp(self):
        from tarunai_connect.wiremock.utils.client import WireMockClient
        from tarunai_connect.wiremock.core.recording import RecordingManager
        self.client = WireMockClient()
...
class TestSettingsManager(unittest.TestCase):
    def setUp(self):
        from tarunai_connect.wiremock.utils.client import WireMockClient
        from tarunai_connect.wiremock.core.settings import SettingsManager
        self.client = WireMockClient()
...
class TestOutputFunctions(unittest.TestCase):
    def test_print_json(self):
        from tarunai_connect.wiremock.utils.output import print_json
        import io
    ...
    def test_success_json_mode(self):
        from tarunai_connect.wiremock.utils.output import success
        with patch("builtins.print") as mock_print:
    ...
    def test_error_json_mode(self):
        from tarunai_connect.wiremock.utils.output import error
        with patch("builtins.print") as mock_print:
