"""E2E / subprocess tests for the tarunai-connect-wiremock CLI.
...
CLI_ENV_KEY = "TARUNAI_CONNECT_FORCE_INSTALLED"
...
def _resolve_cli(name: str) -> list:
    ...
    return [sys.executable, "-m", "tarunai_connect.wiremock.wiremock_cli"]


CLI_CMD = _resolve_cli("tarunai-connect-wiremock")
