...
rootdir: C:\Users\gram\Downloads\코덱스 프로젝트\오픈소스 CLI변환\tarunAI Connect\mermaid\agent-harness
plugins: cov-7.0.0
collecting ... collected 10 items

tarunai_connect/mermaid/tests/test_core.py::test_default_state PASSED
tarunai_connect/mermaid/tests/test_core.py::test_save_open_roundtrip PASSED
tarunai_connect/mermaid/tests/test_core.py::test_undo_redo PASSED
tarunai_connect/mermaid/tests/test_core.py::test_backend_serialization_and_urls PASSED
tarunai_connect/mermaid/tests/test_core.py::test_share_payload PASSED
tarunai_connect/mermaid/tests/test_full_e2e.py::TestMermaidCLI::test_help PASSED
tarunai_connect/mermaid/tests/test_full_e2e.py::TestMermaidCLI::test_project_new_json PASSED
tarunai_connect/mermaid/tests/test_full_e2e.py::TestMermaidCLI::test_render_svg PASSED
tarunai_connect/mermaid/tests/test_full_e2e.py::TestMermaidCLI::test_render_png PASSED
tarunai_connect/mermaid/tests/test_full_e2e.py::TestMermaidCLI::test_share_view_url PASSED
