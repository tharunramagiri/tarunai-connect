...
- [ ] Canonical `SKILL.md` exists at `skills/tarunai-connect-<software>/SKILL.md`
- [ ] Packaged compatibility `SKILL.md` exists at `tarunai_connect/<software>/skills/SKILL.md`
- [ ] Unit tests at `tarunai_connect/<software>/tests/test_core.py` are present and pass without backend
- [ ] E2E tests at `tarunai_connect/<software>/tests/test_full_e2e.py` are present
...
- [ ] All unit tests pass: `python3 -m pytest tarunai_connect/<software>/tests/test_core.py -v`
- [ ] All E2E tests pass: `python3 -m pytest tarunai_connect/<software>/tests/test_full_e2e.py -v`
