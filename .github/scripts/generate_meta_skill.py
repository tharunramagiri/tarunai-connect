...
def main():
    ...
    lines = [
        ...
        "pip install tarunai-connect-hub",
        "",
    ...
    lines.extend([
        ...
        "",
        "- **Harness CLIs**: installed via `pip` as `tarunai-connect-<name>` packages",
        ...
        "```bash",
        "# Interactive REPL",
        "tarunai-connect-<name>",
        "",
        "# One-shot command",
        "tarunai-connect-<name> <group> <command> [options]",
        "",
        "# JSON output for agents",
        "tarunai-connect-<name> --json <group> <command>",
        "```",
        "",
        "## For AI Agents",
        "",
        "1. Install the hub: `pip install tarunai-connect-hub`",
        ...
        "- Web Hub: https://chat.ramagiritharun.in",
