...
Run with:
    python3 -m pytest tarunai_connect/openscreen/tests/test_full_e2e.py -v -s
...
from tarunai_connect.openscreen.core.session import Session
from tarunai_connect.openscreen.core import project as proj_mod
from tarunai_connect.openscreen.core import timeline as tl_mod
from tarunai_connect.openscreen.core import export as export_mod
from tarunai_connect.openscreen.core import media as media_mod
from tarunai_connect.openscreen.core import preview as preview_mod
from tarunai_connect.openscreen.utils import ffmpeg_backend
...
def _resolve_cli(name: str):
    ...
    module = "tarunai_connect.openscreen.openscreen_cli"
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-openscreen")
