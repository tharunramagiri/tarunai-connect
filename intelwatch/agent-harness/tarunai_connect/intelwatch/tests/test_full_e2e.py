...
import tarunai_connect.intelwatch.intelwatch_cli as intelwatch_cli
...
class TestE2E(unittest.TestCase):
    def test_e2e_harness(self):
        ...
        with patch('tarunai_connect.intelwatch.intelwatch_cli.subprocess.call') as mock_call, \
             patch('tarunai_connect.intelwatch.intelwatch_cli.sys.exit') as mock_exit:
