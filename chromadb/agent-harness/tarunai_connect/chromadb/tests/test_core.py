"""Unit tests for the ChromaDB tarunAI Connect harness.
...
from tarunai_connect.chromadb.utils.chromadb_backend import ChromaDBBackend
...
class TestBackendServerCommands:
    ...
    @patch("tarunai_connect.chromadb.utils.chromadb_backend.requests.Session")
...
class TestCLIParsing:
    ...
    @pytest.fixture
    def cli(self):
        from tarunai_connect.chromadb.chromadb_cli import cli
        return cli
    ...
    @patch("tarunai_connect.chromadb.utils.chromadb_backend.ChromaDBBackend.heartbeat")
    ...
    @patch("tarunai_connect.chromadb.utils.chromadb_backend.ChromaDBBackend.version")
    ...
    @patch("tarunai_connect.chromadb.utils.chromadb_backend.ChromaDBBackend.list_collections")
