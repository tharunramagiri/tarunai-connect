...
- [x] `tarunai-connect-chromadb --help` returns exit code 0
...
# Run all tests
python -m pytest tarunai_connect/chromadb/tests/ -v --tb=short

# Run only unit tests (no external deps)
python -m pytest tarunai_connect/chromadb/tests/test_core.py -v

# Run only E2E tests (requires ChromaDB at localhost:8000)
python -m pytest tarunai_connect/chromadb/tests/test_full_e2e.py -v
```
