...
from tarunai_connect.firefly_iii.utils.firefly_iii_backend import FireflyIIIBackend


class TestFireflyIIIBackend:
    """Test Firefly III backend client"""

    @patch('tarunai_connect.firefly_iii.utils.firefly_iii_backend.requests.get')
    ...
    @patch('tarunai_connect.firefly_iii.utils.firefly_iii_backend.requests.get')
    @patch('tarunai_connect.firefly_iii.utils.firefly_iii_backend.requests.request')
...
class TestFireflyIIIBackendMethods:
    ...
    def backend(self):
        ...
        with patch('tarunai_connect.firefly_iii.utils.firefly_iii_backend.requests.get') as mock_get:
            mock_response = Mock()
            mock_response.status_code = 200
            mock_response.json.return_value = {"data": {"version": "6.0.0"}}
            mock_get.return_value = mock_response
...
class TestOutput:
    ...
    def test_json_output(self, capsys):
        """Test JSON output"""
        from tarunai_connect.firefly_iii.firefly_iii_cli import output
        import tarunai_connect.firefly_iii.firefly_iii_cli as cli_module
...
class TestCommandGroups:
    ...
    def test_all_command_groups_importable(self):
        ...
        from tarunai_connect.firefly_iii.core import (
    ...
    def test_cli_has_all_commands(self):
        ...
        from tarunai_connect.firefly_iii.firefly_iii_cli import cli
...
class TestCLIClick:
    ...
    def test_accounts_subcommands(self):
        ...
        from tarunai_connect.firefly_iii.core.accounts import accounts
    ...
    def test_transactions_subcommands(self):
        ...
        from tarunai_connect.firefly_iii.core.transactions import transactions
    ...
    def test_budgets_subcommands(self):
        ...
        from tarunai_connect.firefly_iii.core.budgets import budgets
    ...
    def test_autocomplete_subcommands(self):
        ...
        from tarunai_connect.firefly_iii.core.autocomplete import autocomplete
    ...
    def test_rules_subcommands(self):
        ...
        from tarunai_connect.firefly_iii.core.rules import rules
    ...
    def test_webhooks_subcommands(self):
        ...
        from tarunai_connect.firefly_iii.core.webhooks import webhooks
