...
Usage:
    ...
    tarunai-connect-videocaptioner synthesize video.mp4 -s sub.srt --subtitle-mode hard
    tarunai-connect-videocaptioner process video.mp4 --asr bijian --translator bing --target-language ja
...
from tarunai_connect.videocaptioner.utils import vc_backend
from tarunai_connect.videocaptioner.core import transcribe as transcribe_mod
from tarunai_connect.videocaptioner.core import subtitle as subtitle_mod
from tarunai_connect.videocaptioner.core import synthesize as synthesize_mod
from tarunai_connect.videocaptioner.core import pipeline as pipeline_mod
from tarunai_connect.videocaptioner.core import review as review_mod
...
def repl():
    ...
    from tarunai_connect.videocaptioner.utils.repl_skin import ReplSkin
