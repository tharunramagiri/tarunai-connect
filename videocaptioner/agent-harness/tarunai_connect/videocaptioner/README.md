...
# Transcribe only
tarunai-connect-videocaptioner transcribe video.mp4 --asr bijian -o output.srt

# Translate existing subtitles
tarunai-connect-videocaptioner subtitle input.srt --translator google --target-language ja
