"""Conditional end-to-end tests for tarunai-connect-nsight-graphics."""
...
from tarunai_connect.nsight_graphics.utils.nsight_graphics_backend import probe_installation
...
def _resolve_cli(name: str) -> list[str]:
    ...
    return [sys.executable, "-m", "tarunai_connect.nsight_graphics.nsight_graphics_cli"]


CLI_BASE = _resolve_cli("tarunai-connect-nsight-graphics")
