"""Unit tests for tarunai-connect-nsight-graphics."""
...
from tarunai_connect.nsight_graphics.core import cpp_capture, frame, gpu_trace, launch, replay
from tarunai_connect.nsight_graphics.utils import nsight_graphics_backend as backend
from tarunai_connect.nsight_graphics.utils.errors import handle_error
from tarunai_connect.nsight_graphics.utils.output import output_json
...
class TestBackendDiscovery:
    def test_default_windows_install_dirs_prefers_higher_version(self):
        with patch("tarunai_connect.nsight_graphics.utils.nsight_graphics_backend._fixed_windows_drive_roots", return_value=["C:", "D:"]):
    ...
    def test_list_installations_reports_versions(self, tmp_path):
        ...
        with patch("tarunai_connect.nsight_graphics.utils.backend.discovery._read_registry_installations", return_value=[]):
    ...
    def test_list_installations_includes_registry_only_entries(self):
        ...
        with patch("tarunai_connect.nsight_graphics.utils.backend.discovery._read_registry_installations", return_value=registry_entries):
            result = backend.list_installations(
                env={},
                which=lambda _: None,
                glob_func=lambda _: [],
    ...
    def test_list_installations_promotes_newer_drive_install(self, tmp_path):
        ...
        with patch("tarunai_connect.nsight_graphics.utils.nsight_graphics_backend._fixed_windows_drive_roots", return_value=["C:", "D:"]), \
             patch("tarunai_connect.nsight_graphics.utils.nsight_graphics_backend._read_registry_installations", return_value=[]):
            result = backend.list_installations(
                env={},
                which=lambda _: None,
...
class TestCoreModules:
    @patch("tarunai_connect.nsight_graphics.core.frame.backend.run_with_artifacts")
    @patch("tarunai_connect.nsight_graphics.core.frame.backend.build_unified_command")
    @patch("tarunai_connect.nsight_graphics.core.frame.backend.probe_installation")
    ...
    @patch("tarunai_connect.nsight_graphics.core.gpu_trace.backend.probe_installation")
    ...
    @patch("tarunai_connect.nsight_graphics.core.launch.backend.run_command")
    @patch("tarunai_connect.nsight_graphics.core.launch.backend.build_unified_command")
    @patch("tarunai_connect.nsight_graphics.core.launch.backend.probe_installation")
    ...
    @patch("tarunai_connect.nsight_graphics.core.cpp_capture.backend.run_with_artifacts")
    @patch("tarunai_connect.nsight_graphics.core.cpp_capture.backend.build_unified_command")
    @patch("tarunai_connect.nsight_graphics.core.cpp_capture.backend.probe_installation")
    ...
    @patch("tarunai_connect.nsight_graphics.core.gpu_trace.backend.run_with_artifacts")
    @patch("tarunai_connect.nsight_graphics.core.gpu_trace.backend.build_unified_command")
    @patch("tarunai_connect.nsight_graphics.core.gpu_trace.backend.probe_installation")
    ...
    @patch("tarunai_connect.nsight_graphics.core.replay.backend.run_command")
    @patch("tarunai_connect.nsight_graphics.core.replay.backend.probe_installation")
...
class TestCLIHelp:
    def test_root_help(self):
        ...
        from tarunai_connect.nsight_graphics.nsight_graphics_cli import cli
    ...
    def test_nsight_path_is_forwarded_to_doctor(self):
        ...
        runner = CliRunner()
        with patch("tarunai_connect.nsight_graphics.nsight_graphics_cli.doctor.get_installation_report") as doctor_mock:
    ...
    def test_replay_analyze_json_cli(self, tmp_path):
        ...
        capture_file.write_text("capture", encoding="utf-8")
        runner = CliRunner()
        with patch("tarunai_connect.nsight_graphics.nsight_graphics_cli.replay.analyze_capture") as analyze_mock:
...
class TestCLISubprocess:
    def test_cli_help_subprocess(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "tarunai_connect.nsight_graphics.nsight_graphics_cli", "--help"],
            capture_output=True,
            text=True,
            timeout=15,
