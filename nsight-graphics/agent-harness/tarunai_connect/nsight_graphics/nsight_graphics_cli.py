...
from tarunai_connect.nsight_graphics.core import cpp_capture, doctor, frame, gpu_trace, launch, replay
...
@click.version_option(package_name="tarunai-connect-nsight-graphics")
@click.pass_context
...
def repl(ctx):
    ...
    from tarunai_connect.nsight_graphics.utils.repl_skin import ReplSkin
