# tarunai-connect-nsight-graphics
...
`tarunai-connect-nsight-graphics` entry point points at an old worktree.
...
```bash
tarunai-connect-nsight-graphics launch detached ^
...
```bash
tarunai-connect-nsight-graphics launch attach ^
  --activity "Graphics Capture" ^
  --pid 12345
```
