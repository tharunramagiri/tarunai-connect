...
tarunai-connect-3mf info <file.3mf>

# Detect cylindrical holes (center, diameter, confidence)
tarunai-connect-3mf inspect <file.3mf>

# Resize holes to target diameter
tarunai-connect-3mf resize <file.3mf> --hole 0 --hole 1 --diameter 4.2 -o output.3mf

# Fix mesh issues (degenerate faces, duplicate vertices, normals)
tarunai-connect-3mf repair <file.3mf> -o repaired.3mf

# Compare two 3MF files
tarunai-connect-3mf compare <file1.3mf> <file2.3mf>
```
