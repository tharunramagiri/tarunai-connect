...
3. **Install**: `pip install tarunai-connect-iterm2` (or `pip install -e .` from source)
...
tarunai-connect-iterm2 session set-var user.role "log-tail"
tarunai-connect-iterm2 session set-var user.role "editor"
```
...
tarunai-connect-iterm2 --json session scrollback --tail 200 --strip
