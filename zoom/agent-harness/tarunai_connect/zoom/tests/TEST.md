...
- **Skipped by default** — set `TARUNAI_CONNECT_ZOOM_E2E=1` to enable
...
python3 -m pytest tarunai_connect/zoom/tests/test_core.py -v

# E2E tests (requires Zoom OAuth setup)
TARUNAI_CONNECT_ZOOM_E2E=1 python3 -m pytest tarunai_connect/zoom/tests/test_full_e2e.py -v

# All tests
python3 -m pytest tarunai_connect/zoom/tests/ -v
```
