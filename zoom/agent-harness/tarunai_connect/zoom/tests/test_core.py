...
from tarunai_connect.zoom.zoom_cli import cli
...
def tmp_config_dir(tmp_path):
    ...
    config_dir = tmp_path / ".tarunai-connect-zoom"
    config_dir.mkdir()
    return config_dir
...
def mock_config(tmp_config_dir):
    ...
    with patch("tarunai_connect.zoom.utils.zoom_backend.CONFIG_DIR", tmp_config_dir), \
         patch("tarunai_connect.zoom.utils.zoom_backend.TOKEN_FILE", tmp_config_dir / "tokens.json"), \
         patch("tarunai_connect.zoom.utils.zoom_backend.CONFIG_FILE", tmp_config_dir / "config.json"):
...
class TestAuthLogin:
    ...
    def test_login_with_code(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.utils.zoom_backend.requests.post",
                    return_value=mock_response), \
             patch("tarunai_connect.zoom.utils.zoom_backend.api_get",
...
class TestMeetingCommands:
    ...
    def test_create_meeting(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.core.meetings.api_post",
    ...
    def test_list_meetings(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.core.meetings.api_get",
    ...
    def test_delete_meeting(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.core.meetings.api_delete",
    ...
    def test_update_meeting(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.core.meetings.api_patch"):
            result = runner.invoke(cli, [
...
class TestParticipantCommands:
    ...
    def test_add_participant(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.core.participants.api_post",
    ...
    def test_list_registrants(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.core.participants.api_get",
                    return_value=mock_result):
            result = runner.invoke(cli, [
...
class TestRecordingCommands:
    ...
    def test_list_recordings(self, runner, mock_config):
        ...
        with patch("tarunai_connect.zoom.core.recordings.api_get",
                    return_value=mock_result):
    ...
    def test_download_recording_uses_direct_url(self, tmp_path):
        ...
        from tarunai_connect.zoom.core.recordings import download_recording
        ...
        with patch(
            "tarunai_connect.zoom.core.recordings.api_request",
            side_effect=AssertionError("api_request should not be used"),
            create=True,
        ) as mock_api_request, \
             patch(
                 "tarunai_connect.zoom.utils.zoom_backend._get_valid_token",
...
class TestBackend:
    ...
    def test_config_save_load(self, mock_config):
        ...
        from tarunai_connect.zoom.utils.zoom_backend import save_config, load_config
    ...
    def test_token_save_load(self, mock_config):
        ...
        from tarunai_connect.zoom.utils.zoom_backend import save_tokens, load_tokens
    ...
    def test_save_config_restricts_directory_and_file(self, mock_config):
        ...
        from tarunai_connect.zoom.utils.zoom_backend import save_config

        with patch("tarunai_connect.zoom.utils.zoom_backend._restrict_path") as mock_restrict:
            save_config({"client_id": "abc", "client_secret": "xyz"})
    ...
    def test_save_tokens_restricts_directory_and_file(self, mock_config):
        ...
        from tarunai_connect.zoom.utils.zoom_backend import save_tokens
    ...
    def test_get_config_dir_sets_posix_700_permissions(self, mock_config):
        ...
        from tarunai_connect.zoom.utils.zoom_backend import get_config_dir
    ...
    def test_authorize_url(self):
        ...
        from tarunai_connect.zoom.utils.zoom_backend import get_authorize_url
    ...
    def test_load_empty_config(self, mock_config):
        ...
        from tarunai_connect.zoom.utils.zoom_backend import load_config
        result = load_config()
        assert result == {}

    def test_load_empty_tokens(self, mock_config):
        """load_tokens should return empty dict when no token file."""
        from tarunai_connect.zoom.utils.zoom_backend import load_tokens
        result = load_tokens()
        assert result == {}
