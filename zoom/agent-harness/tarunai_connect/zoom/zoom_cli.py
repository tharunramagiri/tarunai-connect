...
Usage:
    ...
    tarunai-connect-zoom auth setup --client-id <ID> --client-secret <SECRET>

    # Login via browser
    tarunai-connect-zoom auth login

    # Create a meeting
    tarunai-connect-zoom meeting create --topic "Standup" --duration 30
...
from tarunai_connect.zoom.core import auth as auth_mod
from tarunai_connect.zoom.core import meetings as meet_mod
from tarunai_connect.zoom.core import participants as part_mod
from tarunai_connect.zoom.core import recordings as rec_mod
...
def repl():
    ...
    from tarunai_connect.zoom.utils.repl_skin import ReplSkin
