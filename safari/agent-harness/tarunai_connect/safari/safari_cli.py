...
Usage:
    ...
    tarunai-connect-safari --json tool read-page
    ...
    tarunai-connect-safari raw safari_evaluate --json-args '{"script":"document.title"}'
"""
...
from tarunai_connect.safari.core.session import Session
from tarunai_connect.safari.utils import safari_backend as backend
from tarunai_connect.safari.utils import security as security_mod
from tarunai_connect.safari.utils.tool_registry import (
    ToolParam,
    ToolSchema,
    coerce_arg_value,
    load_registry,
...
def tool_group():
    ...
    ``tarunai-connect-safari tools list`` to see them, and
    ``tarunai-connect-safari tools describe <name>`` for full details.
    """
...
def repl():
    ...
    from tarunai_connect.safari.utils.repl_skin import ReplSkin
