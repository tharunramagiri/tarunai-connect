"""Unit tests for tarunai-connect-safari — Core modules with mocked backend.
...
Usage:
    python -m pytest tarunai_connect/safari/tests/test_core.py -v
"""
...
class TestUnwrap:
    def test_unwrap_json_text(self):
        from tarunai_connect.safari.utils.safari_backend import _unwrap
