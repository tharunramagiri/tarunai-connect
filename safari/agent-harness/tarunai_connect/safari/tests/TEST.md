...
This harness deviates from the standard tarunAI Connect test rules in
...
- CI environments and the package maintainer should set
  ...
  `SAFARI_E2E=1 TARUNAI_CONNECT_FORCE_INSTALLED=1 pytest …` runs all
...
- Snapshot already exists at the safari-mcp level
  ...
  exposed via `tarunai-connect-safari tool snapshot`. The CLI does not
...
- **TestParityToolCoverage** (5 tests)
  ...
  - Every tool in the registry is reachable as `tarunai-connect-safari tool <short-name>`
...
rootdir: /Users/am/tarunAI Connect/safari/agent-harness
plugins: anyio-4.13.0
collecting ... collected 95 items

tarunai_connect/safari/tests/test_core.py::TestPlatformCheck::test_refuses_non_darwin PASSED
tarunai_connect/safari/tests/test_core.py::TestPlatformCheck::test_accepts_darwin_if_deps_present PASSED
tarunai_connect/safari/tests/test_core.py::TestUnwrap::test_unwrap_json_text PASSED
tarunai_connect/safari/tests/test_core.py::TestUnwrap::test_unwrap_plain_text PASSED
tarunai_connect/safari/tests/test_core.py::TestUnwrap::test_unwrap_multiple_parts PASSED
tarunai_connect/safari/tests/test_core.py::TestUnwrap::test_unwrap_empty PASSED
tarunai_connect/safari/tests/test_core.py::TestUnwrap::test_unwrap_image_content PASSED
tarunai_connect/safari/tests/test_core.py::TestUnwrap::test_unwrap_image_content_default_mimetype PASSED
tarunai_connect/safari/tests/test_core.py::TestCallForwarding::test_strips_none_args_before_call PASSED
tarunai_connect/safari/tests/test_core.py::TestCallForwarding::test_passes_full_arg_set_when_none_omitted PASSED
tarunai_connect/safari/tests/test_core.py::TestCallForwarding::test_unwraps_plain_text_when_not_json PASSED
tarunai_connect/safari/tests/test_core.py::TestSessionState::test_session_defaults PASSED
tarunai_connect/safari/tests/test_core.py::TestSessionState::test_set_url_updates_last_url PASSED
tarunai_connect/safari/tests/test_core.py::TestSessionState::test_set_tab_updates_current_tab PASSED
tarunai_connect/safari/tests/test_core.py::TestSessionState::test_status_contains_expected_keys PASSED
tarunai_connect/safari/tests/test_core.py::TestSessionState::test_status_empty_url_returns_sentinel PASSED
tarunai_connect/safari/tests/test_full_e2e.py::TestDependencyChecks::test_cli_help_works SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestDependencyChecks::test_cli_shows_all_command_groups SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestSessionCommands::test_session_status_json SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestSecurityIntegration::test_file_url_blocked SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestSecurityIntegration::test_javascript_url_blocked SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestSecurityIntegration::test_about_url_blocked SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestSecurityIntegration::test_missing_scheme_rejected SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestSecurityIntegration::test_raw_navigate_also_blocked SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestRealSafariRoundTrip::test_tab_list_returns_json SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestRealSafariRoundTrip::test_navigate_and_read_example_com SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_help SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_tool_group_help SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_tools_count_is_84 SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_tools_describe_scroll SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_tool_scroll_help_uses_schema SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_raw_help SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_session_status_json SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_blocked_scheme_exits_nonzero SKIPPED
tarunai_connect/safari/tests/test_full_e2e.py::TestCLISubprocess::test_list_tabs_json_roundtrip SKIPPED
tarunai_connect/safari/tests/test_parity.py::TestParityToolCoverage::test_registry_not_empty PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityToolCoverage::test_registry_tool_count_matches_expected PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityToolCoverage::test_every_tool_reachable_via_tool_group PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityToolCoverage::test_tool_group_has_exactly_registry_count PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityToolCoverage::test_no_unexpected_tools_in_cli PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityParameters::test_every_param_has_cli_option PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityParameters::test_required_params_are_required_in_click PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityParameters::test_enum_choices_match PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityIntrospection::test_tools_count_command PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityIntrospection::test_tools_list_outputs_every_tool PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityIntrospection::test_tools_list_json_shape PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityIntrospection::test_tools_describe_known_tool PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityIntrospection::test_tools_describe_by_short_name PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityIntrospection::test_tools_describe_unknown_rejects PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_scroll_uses_direction_not_xy PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_drag_uses_source_and_target PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_mock_route_uses_url_pattern PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_throttle_network_has_profile PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_mock_route_response_is_required_not_status_description PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_run_script_steps_is_required_and_described_correctly PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_fill_form_fields_description_is_outer_not_inner PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_fill_and_submit_fields_description_is_outer PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_evaluate_param_is_script_not_code PASSED
tarunai_connect/safari/tests/test_parity.py::TestParityHighValueSchemas::test_run_script_param_is_steps PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_valid_http_url PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_valid_https_url PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_valid_https_with_path_and_query PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_valid_https_with_port PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_blocked_file_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_blocked_javascript_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_blocked_data_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_blocked_about_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_blocked_vbscript_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_blocked_webkit_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_blocked_safari_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_empty_string PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_whitespace_only PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_none_input PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_non_string_input PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_missing_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_missing_hostname PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_unknown_scheme PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_unknown_scheme_ws PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_get_allowed_schemes PASSED
tarunai_connect/safari/tests/test_security.py::TestURLValidation::test_get_blocked_schemes PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_plain_text_unchanged PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_empty_text_returns_empty PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_none_passes_through PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_truncation PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_default_max_length PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_prompt_injection_flagged PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_chinese_injection_flagged PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_html_comment_flagged PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_script_tag_flagged PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_control_chars_stripped PASSED
tarunai_connect/safari/tests/test_security.py::TestDOMSanitization::test_newlines_preserved PASSED
tarunai_connect/safari/tests/test_security.py::TestPrivateNetworkConfig::test_default_private_not_blocked PASSED
tarunai_connect/safari/tests/test_security.py::TestPrivateNetworkConfig::test_localhost_allowed_by_default PASSED
tarunai_connect/safari/tests/test_security.py::TestPrivateNetworkConfig::test_127_0_0_1_allowed_by_default PASSED
tarunai_connect/safari/tests/test_security.py::TestPrivateNetworkConfig::test_private_ip_allowed_by_default PASSED

======================== 76 passed, 19 skipped in 0.41s ========================
```

**Summary:** 76 passed, 19 skipped (all E2E, gated on `SAFARI_E2E=1`).
With `SAFARI_E2E=1 TARUNAI_CONNECT_FORCE_INSTALLED=1` the full suite is
...
$ tarunai-connect-safari --json tool evaluate --script "document.title"
...
$ tarunai-connect-safari --json tool screenshot
...
python -m pytest tarunai_connect/safari/tests/ -v --tb=no

# Full suite with E2E (requires Safari + macOS + Apple Events)
SAFARI_E2E=1 TARUNAI_CONNECT_FORCE_INSTALLED=1 \
    python -m pytest tarunai_connect/safari/tests/ -v -s

# Just the parity check (core of the "exact parity" guarantee)
python -m pytest tarunai_connect/safari/tests/test_parity.py -v
```
