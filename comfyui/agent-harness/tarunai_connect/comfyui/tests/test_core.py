...
from tarunai_connect.comfyui.core import workflows as workflow_mod
from tarunai_connect.comfyui.core import queue as queue_mod
from tarunai_connect.comfyui.core import models as models_mod
from tarunai_connect.comfyui.core import images as images_mod
...
class TestQueuePrompt:
    ...
    def test_queue_prompt_success(self, sample_workflow):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_post", return_value=mock_response):
    ...
    def test_queue_prompt_with_client_id(self, sample_workflow):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_post", return_value=mock_response) as mock_post:
...
class TestQueueStatus:
    ...
    def test_get_queue_status(self):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_get", return_value=mock_response):
...
class TestQueueClear:
    ...
    def test_clear_queue(self):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_delete", return_value={"status": "ok"}):
    ...
    def test_clear_queue_passes_clear_flag(self):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_delete", return_value={}) as mock_del:
...
class TestQueueHistory:
    ...
    def test_get_prompt_history_not_found(self):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_get", return_value={}):
            with pytest.raises(RuntimeError, match="not found"):
                queue_mod.get_prompt_history("http://localhost:8188", "nonexistent-id")

    def test_interrupt(self):
        """Should call interrupt endpoint and return status."""
        with patch("tarunai_connect.comfyui.core.queue.api_post", return_value={}):
...
class TestModels:
    ...
    def test_list_checkpoints(self):
        ...
        with patch("tarunai_connect.comfyui.core.models.api_get", return_value=mock_resp):
    ...
    def test_list_checkpoints_bad_response_raises(self):
        ...
        with patch("tarunai_connect.comfyui.core.models.api_get", return_value={}):
...
class TestImages:
    ...
    def test_list_output_images(self):
        ...
        with patch("tarunai_connect.comfyui.core.images.get_prompt_history",
    ...
    def test_download_image(self, tmp_path):
        ...
        with patch("tarunai_connect.comfyui.core.images.api_get_raw", return_value=fake_png):
    ...
    def test_download_prompt_images(self, tmp_path):
        ...
        with patch("tarunai_connect.comfyui.core.images.get_prompt_history", return_value=mock_history), \
             patch("tarunai_connect.comfyui.core.images.api_get_raw", return_value=fake_png):
...
class TestCLIQueue:
    ...
    def test_queue_clear_with_confirm(self, runner):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_delete", return_value={}):
...
class TestCLISystem:
    ...
    def test_system_stats(self, runner):
        ...
        with patch("tarunai_connect.comfyui.comfyui_cli.api_get", return_value=mock_stats):
...
class TestBackend:
    ...
    def test_api_get_success(self):
        ...
        from tarunai_connect.comfyui.utils.comfyui_backend import api_get
        ...
        with patch("tarunai_connect.comfyui.utils.comfyui_backend.requests.get",
    ...
    def test_api_post_success(self):
        ...
        from tarunai_connect.comfyui.utils.comfyui_backend import api_post
        ...
        with patch("tarunai_connect.comfyui.utils.comfyui_backend.requests.post",
                   return_value=mock_resp):
    ...
    def test_api_delete_success(self):
        ...
        from tarunai_connect.comfyui.utils.comfyui_backend import api_delete
        ...
        with patch("tarunai_connect.comfyui.utils.comfyui_backend.requests.delete",
                   return_value=mock_resp):
    ...
    def test_api_get_raw_returns_bytes(self):
        ...
        from tarunai_connect.comfyui.utils.comfyui_backend import api_get_raw
