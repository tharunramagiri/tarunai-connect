...
class TestFullGenerationWorkflow:
    ...
    def test_queue_and_check_status(self, runner, workflow_file):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_post", return_value=queue_response), \
             patch("tarunai_connect.comfyui.core.queue.api_get", return_value=status_response):
    ...
    def test_queue_then_download(self, runner, workflow_file, tmp_path):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_post",
                   return_value={"prompt_id": prompt_id, "number": 0, "node_errors": {}}), \
             patch("tarunai_connect.comfyui.core.queue.api_get", return_value=history_response), \
    ...
    def test_clear_queue_and_verify(self, runner):
        ...
        with patch("tarunai_connect.comfyui.core.queue.api_delete", return_value={}), \
             patch("tarunai_connect.comfyui.core.queue.api_get", return_value=empty_status):
...
class TestModelDiscovery:
    ...
    def test_discover_all_model_types(self, runner):
        ...
        with patch("tarunai_connect.comfyui.core.models.api_get") as mock_api:
...
class TestErrorHandling:
    ...
    def test_download_missing_image_shows_error(self, runner, tmp_path):
        ...
        with patch("tarunai_connect.comfyui.core.images.api_get_raw",
