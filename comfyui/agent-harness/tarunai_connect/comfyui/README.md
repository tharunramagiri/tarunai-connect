...
# List workflows
tarunai-connect-comfyui workflow list
...
# List output images
tarunai-connect-comfyui images list --prompt-id <prompt_id>

# Download an output image
tarunai-connect-comfyui images download --filename ComfyUI_00001_.png --output ./output.png
...
```bash
tarunai-connect-comfyui --json models checkpoints
tarunai-connect-comfyui --json queue status
...
```bash
tarunai-connect-comfyui --url http://192.168.1.100:8188 system stats
```
