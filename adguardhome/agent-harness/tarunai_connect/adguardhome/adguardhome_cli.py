"""tarunai-connect-adguardhome - CLI harness for AdGuardHome."""
...
from tarunai_connect.adguardhome.core import blocking as blocking_core
from tarunai_connect.adguardhome.core import clients as clients_core
from tarunai_connect.adguardhome.core import dhcp as dhcp_core
from tarunai_connect.adguardhome.core import filtering as filtering_core
from tarunai_connect.adguardhome.core import log as log_core
from tarunai_connect.adguardhome.core import project
from tarunai_connect.adguardhome.core import rewrite as rewrite_core
from tarunai_connect.adguardhome.core import server as server_core
from tarunai_connect.adguardhome.core import stats as stats_core
from tarunai_connect.adguardhome.utils.adguardhome_backend import AdGuardHomeClient
from tarunai_connect.adguardhome.utils.repl_skin import ReplSkin
...
def cli(ctx: click.Context, host, port, username, password, config_path, use_https, as_json):
    """tarunai-connect-adguardhome - control AdGuardHome from the command line."""
