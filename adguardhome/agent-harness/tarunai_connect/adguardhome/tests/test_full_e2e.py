"""E2E and subprocess tests for tarunai-connect-adguardhome.
...
def _resolve_cli(name: str) -> list[str]:
    ...
    module = "tarunai_connect.adguardhome.adguardhome_cli"
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-adguardhome")
