...
Usage:
    ...
    tarunai-connect-obsidian --api-key YOUR_KEY vault read "My Note.md"
    tarunai-connect-obsidian --api-key YOUR_KEY --json search query "tag:#project"

    # Interactive REPL
    tarunai-connect-obsidian --api-key YOUR_KEY
"""
...
from tarunai_connect.obsidian.core import vault as vault_mod
from tarunai_connect.obsidian.core import search as search_mod
from tarunai_connect.obsidian.core import note as note_mod
from tarunai_connect.obsidian.core import command as cmd_mod
from tarunai_connect.obsidian.core import server as server_mod
...
def repl():
    ...
    from tarunai_connect.obsidian.utils.repl_skin import ReplSkin
