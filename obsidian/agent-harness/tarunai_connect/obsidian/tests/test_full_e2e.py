"""E2E tests for tarunai-connect-obsidian — requires Obsidian running with Local REST API plugin.

These tests interact with a real Obsidian instance. Skip if not available.

Usage:
    OBSIDIAN_API_KEY=your-key python -m pytest tarunai_connect/obsidian/tests/test_full_e2e.py -v
"""
...
from tarunai_connect.obsidian.utils.obsidian_backend import is_available, DEFAULT_BASE_URL
...
TEST_NOTE = "_tarunai_connect_test_note.md"
TEST_CONTENT = "# Test Note\n\nCreated by tarunai-connect-obsidian E2E tests."
