"""E2E tests for tarunai-connect-cloudcompare.
...
Run with:
    python3 -m pytest tarunai_connect/cloudcompare/tests/test_full_e2e.py -v -s

Run against the installed CLI command:
    TARUNAI_CONNECT_FORCE_INSTALLED=1 python3 -m pytest tarunai_connect/cloudcompare/tests/test_full_e2e.py -v -s
"""
...
def _resolve_cli(name: str) -> list[str]:
    ...
    module = "tarunai_connect.cloudcompare.cloudcompare_cli"
...
class TestBackendAvailability:
    def test_cloudcompare_is_installed(self):
        ...
        from tarunai_connect.cloudcompare.utils.cc_backend import find_cloudcompare, is_available
        assert is_available(), (
...
class TestFormatConversion:
    def test_xyz_to_ply(self, tmp_dir, cloud_xyz):
        ...
        from tarunai_connect.cloudcompare.utils.cc_backend import convert_format
...
class TestSubsampling:
    def test_spatial_subsample(self, tmp_dir, cloud_xyz):
        ...
        from tarunai_connect.cloudcompare.utils.cc_backend import subsample
...
class TestSORFilter:
    def test_sor_removes_outliers(self, tmp_dir, noisy_cloud_xyz):
        ...
        from tarunai_connect.cloudcompare.utils.cc_backend import sor_filter
...
class TestCSFFilter:
    ...
    def test_csf_cli_command(self, tmp_dir, project_json, scene_cloud):
        ...
        cli = _resolve_cli("tarunai-connect-cloudcompare")
        ground_out = os.path.join(tmp_dir, "ground.las")
...
class TestSFColorOps:
    ...
    def test_sf_to_rgb(self, tmp_dir, cloud_with_sf):
        from tarunai_connect.cloudcompare.utils.cc_backend import sf_to_rgb
    ...
    def test_rgb_to_sf(self, tmp_dir, cloud_with_sf):
        ...
        from tarunai_connect.cloudcompare.utils.cc_backend import sf_to_rgb, rgb_to_sf
...
class TestNormalsOps:
    ...
    def test_invert_normals(self, tmp_dir, cloud_xyz):
        from tarunai_connect.cloudcompare.utils.cc_backend import compute_normals, invert_normals
...
class TestDelaunayMesh:
    ...
    def test_delaunay_creates_mesh(self, tmp_dir, cloud_xyz):
        from tarunai_connect.cloudcompare.utils.cc_backend import delaunay_mesh
    ...
    def test_sample_mesh(self, tmp_dir, cloud_xyz):
        from tarunai_connect.cloudcompare.utils.cc_backend import delaunay_mesh, sample_mesh
...
class TestApplyTransform:
    ...
    def test_apply_identity_matrix(self, tmp_dir, cloud_xyz):
        from tarunai_connect.cloudcompare.utils.cc_backend import apply_transform
...
class TestSegmentCC:
    ...
    def test_extract_two_components(self, tmp_dir, two_cluster_cloud):
        from tarunai_connect.cloudcompare.utils.cc_backend import extract_connected_components
...
class TestExportPipeline:
    def test_export_cloud_to_las(self, tmp_dir, cloud_xyz):
        ...
        from tarunai_connect.cloudcompare.core.export import export_cloud
    ...
    def test_list_presets(self):
        ...
        from tarunai_connect.cloudcompare.core.export import list_presets
...
class TestCLISubprocess:
    CLI_BASE = _resolve_cli("tarunai-connect-cloudcompare")
