"""tarunai-connect-cloudcompare — Command-line harness for CloudCompare.
...
Usage:
    tarunai-connect-cloudcompare                        # start REPL
    tarunai-connect-cloudcompare project new -o p.json  # create project
    tarunai-connect-cloudcompare --project p.json cloud subsample ...
    tarunai-connect-cloudcompare --json project info    # JSON output
...
from tarunai_connect.cloudcompare.core.export import (
    export_cloud,
    export_mesh,
    batch_export,
    list_presets,
...
from tarunai_connect.cloudcompare.utils.cc_backend import (
    apply_transform,
...
from tarunai_connect.cloudcompare.utils.repl_skin import ReplSkin
...
def cli(ctx: click.Context, project: Optional[str], json_output: bool) -> None:
    """tarunai-connect-cloudcompare: Agent-friendly CLI for CloudCompare.
