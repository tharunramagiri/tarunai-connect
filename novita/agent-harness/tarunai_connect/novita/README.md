...
tarunai-connect-novita --json chat --prompt "Hello" --model deepseek/deepseek-v3.2
```
...
tarunai-connect-novita --json session status
```
...
python3 -m pytest tarunai_connect/novita/tests/test_core.py -v

# E2E tests (requires NOVITA_API_KEY)
NOVITA_API_KEY=sk-xxx python3 -m pytest tarunai_connect/novita/tests/test_full_e2e.py -v

# All tests
python3 -m pytest tarunai_connect/novita/tests/ -v
```
