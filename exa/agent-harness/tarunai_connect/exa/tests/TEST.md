...
### TestEntryPoint
- [ ] `tarunai-connect-exa --help` exits 0 via subprocess
- [ ] `tarunai-connect-exa --json search ...` returns valid JSON via subprocess
...
EXA_API_KEY=your-key pytest tarunai_connect/exa/tests/test_full_e2e.py -v

# All tests
pytest tarunai_connect/exa/tests/ -v
```
