...
from tarunai_connect.exa.exa_cli import cli
from tarunai_connect.exa.utils.exa_backend import build_contents_param, CATEGORY_SLUG_MAP
...
class TestSearchCLI:
    @patch("tarunai_connect.exa.core.search.get_client")
...
class TestServerCLI:
    @patch("tarunai_connect.exa.exa_cli.check_connectivity")
