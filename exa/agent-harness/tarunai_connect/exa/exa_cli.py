...
Usage (non-interactive):
    tarunai-connect-exa search "AI safety papers 2024" --type deep --content highlights
    tarunai-connect-exa contents https://example.com --content text
    tarunai-connect-exa --json search "latest LLM benchmarks" --num-results 3
...
from tarunai_connect.exa.core import search as search_core
from tarunai_connect.exa.utils.exa_backend import check_connectivity
...
def repl() -> None:
    ...
    from tarunai_connect.exa.utils.repl_skin import ReplSkin
