"""tarunai-connect-calibre — Main CLI entry point.
...
Usage:
    tarunai-connect-calibre                          # Enter interactive REPL
    tarunai-connect-calibre library connect <path>   # Set active library
    tarunai-connect-calibre books list               # List books
...
from tarunai_connect.calibre import __version__
from tarunai_connect.calibre.core import session as _session
from tarunai_connect.calibre.core import library as _library
from tarunai_connect.calibre.core import metadata as _metadata
from tarunai_connect.calibre.core import formats as _formats
from tarunai_connect.calibre.core import custom as _custom
from tarunai_connect.calibre.core import export as _export
...
@click.version_option(__version__, prog_name="tarunai-connect-calibre")
@click.pass_context
def main(ctx, as_json, library_path):
    """tarunai-connect-calibre — Calibre e-book manager CLI harness.
...
def repl(ctx):
    ...
    from tarunai_connect.calibre.utils.repl_skin import ReplSkin
