"""E2E tests for tarunai-connect-calibre.
...
Run (dev mode):
    pytest tarunai_connect/calibre/tests/test_full_e2e.py -v -s

Run (installed binary verification):
    TARUNAI_CONNECT_FORCE_INSTALLED=1 pytest tarunai_connect/calibre/tests/test_full_e2e.py -v -s
"""
...
def _resolve_cli(name):
    ...
    module = "tarunai_connect.calibre.calibre_cli"
...
class CalibreTestMixin:
    ...
    def setUpClass(cls):
        ...
        cls.tmp_root = tempfile.mkdtemp(prefix="tarunai-connect-calibre-test-")
...
class TestLibraryOperations(CalibreTestMixin, unittest.TestCase):
    def test_library_info(self):
        from tarunai_connect.calibre.core.library import library_info
    ...
    def test_get_metadata(self):
        from tarunai_connect.calibre.core.metadata import get_metadata
...
class TestMetadataOperations(CalibreTestMixin, unittest.TestCase):
    def test_set_metadata_title(self):
        from tarunai_connect.calibre.core.metadata import set_metadata, get_metadata
...
class TestFormatConversion(CalibreTestMixin, unittest.TestCase):
    def test_convert_epub_to_txt(self):
        ...
        from tarunai_connect.calibre.core.formats import convert_format
    ...
    def test_convert_adds_to_library(self):
        ...
        from tarunai_connect.calibre.core.formats import convert_format, list_formats
...
class TestCLISubprocess(unittest.TestCase):
    """Test the installed tarunai-connect-calibre command via subprocess."""

    CLI_BASE = _resolve_cli("tarunai-connect-calibre")
    ...
    def setUpClass(cls):
        ...
        cls.tmp = tempfile.mkdtemp(prefix="tarunai-connect-calibre-subprocess-")
